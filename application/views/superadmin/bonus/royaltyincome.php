<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	if(_d($_REQUEST['member_id'])>0){
		...
		$StrWhr .=" AND tcr.member_id='".$member_id."'";
	...
	$QR_PAGES= "SELECT tcr.*,  tm.user_id, tm.full_name,
			    ...
			    WHERE tcr.royalty_type='R1' $StrWhr ORDER BY tcr.royalty_cmsn_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Member <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Roaylty Income 2</small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
          <div class="col-xs-12">
            <div class="row">
              <div class="col-xs-4" >
                ...
                <form id="form-search" name="form-search" method="get" action="<?php echo generateAdminForm("bonus","royaltyincome",""); ?>">
              <b>User Id </b>
              ...
              <a href="javascript:void(0)" onClick="window.location.href='?'" class="btn btn-danger btn-sm m-t-n-xs" value=" Reset ">Reset</a>
            </form>
				</div>
                </div>
                <div class="clearfix">&nbsp;</div>
                  ...
                  <table id="no-more-tables" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr class="odd" role="row">
                        ...
                        <td><?php echo $AR_DT['royalty_ratio']; ?> %</td>
