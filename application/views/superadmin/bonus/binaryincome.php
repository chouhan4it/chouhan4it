...
$QR_PAGES="SELECT tp.*, SUM(tcb.net_cmsn) AS sum_net_cmsn
		 FROM tbl_process_binary AS tp 
		 LEFT JOIN tbl_cmsn_binary AS tcb ON tcb.process_id=tp.process_id
          ...
          <div class="col-xs-12">
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="clearfix">
                  <div class="col-md-6">
                    <form id="form-search" name="form-search" method="get" action="<?php echo generateAdminForm("bonus","binaryincome",""); ?>">
                      <b>Process Week </b>
                      ...
                      <a href="<?php echo generateSeoUrlAdmin("member","binaryincome",""); ?>"  class="btn btn-danger btn-sm m-t-n-xs" value=" Reset ">Reset</a>
                    </form>
                  </div>
                </div>
                ...
                <table id="no-more-tables" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <td data-title="Report"><a href="<?php echo generateSeoUrlAdmin("bonus","binaryincomelist",""); ?>?process_id=<?php echo $AR_DT['process_id']; ?>">View</a></td>
                    </tr>
                    <?php $Ctrl++; 
				  	endforeach;
					}else{ ?>
