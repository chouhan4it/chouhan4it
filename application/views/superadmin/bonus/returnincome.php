...
$QR_PAGES = "SELECT tcd.*, tm.user_id , CONCAT_WS(' ',tm.first_name,tm.last_name) AS full_name , tpt.pin_name
			   ...
			   WHERE tcd.return_type LIKE 'CBB' $StrWhr 
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> CashBack <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;  Bonus </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-md-4">
            <form id="form-search" name="form-search" method="get" action="<?php echo generateAdminForm("bonus","returnincome",""); ?>">
              <b>User Id </b>
          ...
          <div class="col-xs-12">
            <table id="no-more-tables" class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php }else{ ?>
                <tr class="odd" role="row">
                  <td colspan="9" class="text-danger">No record found </td>
                </tr>
                <?php
						}
						 ?>
