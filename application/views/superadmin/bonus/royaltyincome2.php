<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	$QR_PAGES= "SELECT tcr.*,  tm.user_id, tm.full_name,
			    ...
			    WHERE tcr.royalty_type='R2' $StrWhr ORDER BY tcr.royalty_cmsn_id DESC";
          ...
          <div class="col-xs-12">
            <div class="row">
              <div class="col-xs-4" >
                ...
                <form id="form-search" name="form-search" method="get" action="<?php echo generateAdminForm("bonus","royaltyincome2",""); ?>">
              <b>User Id </b>
