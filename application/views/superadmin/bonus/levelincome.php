...
if($_REQUEST['from_date']!='' && $_REQUEST['to_date']!=''){
	...
	$StrWhr .=" AND ( DATE(tcd.cmsn_date) BETWEEN '".InsertDate($from_date)."' AND '".InsertDate($to_date)."')";
	$SrchQ .="&from_date=$from_date&to_date=$to_date";
}

$QR_PAGES= "SELECT tcd.*, tmf.user_id, CONCAT_WS(' ',tmf.first_name,tmf.last_name) AS full_name
			FROM tbl_cmsn_lvl_benefit_mstr AS tcd 
			LEFT JOIN tbl_members AS tmf ON tcd.member_id=tmf.member_id
			WHERE  1  $StrWhr 
			ORDER BY tcd.mstr_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Level <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;  Bonus </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-md-4">
            <form id="form-search" name="form-search" method="get" action="<?php echo generateAdminForm("bonus","levelincome",""); ?>">
              <b>User Id </b>
            ...
            <table id="no-more-tables" class="table table-striped table-bordered table-hover">
              <thead>
                <tr role="row">
                  ...
                  <th  class="sorting">Income Date</th>
              ...
              <tbody>
                ...
                <tr class="odd" role="row">
                  ...
                  <td><?php echo getDateFormat($AR_DT['cmsn_date'],"d M Y"); ?></td>
