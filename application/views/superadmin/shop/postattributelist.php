                      ...
                      <tr>
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("shop","postattribute",array("post_attribute_id"=>_e($AR_DT['post_attribute_id']),"post_id"=>_e($AR_DT['post_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                              ...
                              <li> <a onClick="return confirm('Make sure , you want to delete this attribute?')" href="<?php echo generateSeoUrlAdmin("shop","postattribute",array("post_attribute_id"=>_e($AR_DT['post_attribute_id']),"post_id"=>_e($AR_DT['post_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
