...
$QR_PAGES = "SELECT tpr.* , tpl.post_title
			FROM  tbl_post_review AS tpr 
			LEFT JOIN tbl_post AS tp ON tp.post_id=tpr.post_id
			LEFT JOIN tbl_post_lang AS tpl ON tpl.post_id=tp.post_id
			WHERE tp.delete_sts>0
			$StrWhr
			ORDER BY tpr.review_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Product <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Review </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="" class="table">
			       ...
			       ?>
                      <tr>
                        <td width="60" rowspan="2" class="center"><label class="pos-rel"> <img class="img-responsive" src="<?php echo $model->getDefaultPhoto($AR_DT['post_id']); ?>"> <span class="lbl"></span> </label></td>
                        <td width="65"><strong> Product : </strong></td>
                        <td width="219"><?php echo $AR_DT['post_title']; ?></td>
                        <td width="54"><strong>Name :</strong></td>
                        <td width="196"><?php echo $AR_DT['review_by']; ?></td>
                        <td width="57"><strong>Email  : </strong></td>
                        <td width="217"><?php echo $AR_DT['email_id']; ?></td>
                        <td width="94" rowspan="2"><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("shop","review",array("action_request"=>"EDIT","review_id"=>_e($AR_DT['review_id']))); ?>">Edit</a> </li>
                              <li> <a onClick="return confirm('Make sure , you want to change this member status?')" href="<?php echo generateSeoUrlAdmin("shop","review",array("review_id"=>_e($AR_DT['review_id']),"action_request"=>"STATUS","review_sts"=>$AR_DT['review_sts'])); ?>"><?php echo ($AR_DT['review_sts']>0)? "In-Active":"Active"; ?></a> </li>
                              <li> <a onClick="return confirm('Make sure, want to delete this member')" 
							href="<?php echo generateSeoUrlAdmin("shop","review",array("action_request"=>"DELETE","review_id"=>_e($AR_DT['review_id']))); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <tr>
                        <td colspan="6"><i class="fa fa-quote-left" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo ($AR_DT['review_dtls']); ?>&nbsp;&nbsp;<i class="fa fa-quote-right" aria-hidden="true"></i>
                          <p><?php echo getDateFormat($AR_DT['date_time'],"d D Y M"); ?></p></td>
                      </tr>
                      <tr>
  ...
  <div id="search-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("shop","productreview",""); ?>" method="post">
          <div class="modal-body">
            <div class="form-group">
              <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Product Title  :</label>
              <div class="col-sm-7">
                <input id="form-field-1" placeholder="Keywords" name="post_title"  class="col-xs-10 col-sm-12" type="text" value="<?php echo $_REQUEST['post_title']; ?>">
              </div>
            </div>
          </div>
