...
$QR_PAGES= "SELECT tc.* FROM tbl_carrier  AS tc  WHERE tc.delete_sts>0 $StrWhr ORDER BY tc.carrier_id ASC";
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                      <tr>
                        ...
                        <td><a href="#"><?php echo $AR_DT['carrier_name']; ?></a></td>
                        <td><?php echo number_format($AR_DT['carrier_flat_charge'],2); ?></td>
                        <td><?php echo ($AR_DT['carrier_free']>0)? "Yes":"No"; ?></td>
                        <td><?php echo ($AR_DT['carrier_sts']=="1")? "Active":"In-Active"; ?></td>
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("shop","carrier",array("carrier_id"=>_e($AR_DT['carrier_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                              <li> <a onClick="return confirm('Make sure , you want to change this language status?')" href="<?php echo generateSeoUrlAdmin("shop","carrier",array("carrier_id"=>_e($AR_DT['carrier_id']),"action_request"=>"STATUS","carrier_sts"=>$AR_DT['carrier_sts'])); ?>"><?php echo ($AR_DT['carrier_sts']=="0")? "Activate":"De-Activate"; ?></a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <?php $Ctrl++; 
