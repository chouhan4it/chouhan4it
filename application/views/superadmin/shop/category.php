    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1>Category <small> <i class="ace-icon fa fa-angle-double-right"></i>&nbsp; Add / Update </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php  get_message(); ?>
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("shop","category",""); ?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Name </label>
                <div class="col-sm-9">
                  <input id="form-field-1" placeholder="Category Name" name="category_name"  class="col-xs-10 col-sm-5 validate[required]" type="text" value="<?php echo $ROW['category_name']; ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3"> <img src="<?php echo $model->getCategoryImgSrc($ROW['category_id']); ?>" class="img-thumbnail" height="60" width="80"> </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="option_value"> Font Icon </label>
                <div class="col-sm-9">
                  <input id="option_value" placeholder="Font Icon" name="option_value"  class="col-xs-10 col-sm-5" type="text" value="<?php echo $ADD['Font Icon']; ?>">
                </div>
              </div>
              <div class="space-4"></div>
              <div class="clearfix form-action">
                <div class="col-md-offset-3 col-md-9">
                  ...
                  <input type="hidden" name="parent_id" id="parent_id" value="<?php echo ($ROW['parent_id'])? _e($ROW['parent_id']):_e($parent_id); ?>">
