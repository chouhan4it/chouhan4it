<?php defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 $order_no = $model->franchiseOrderNo($model->getDefaultFranchisee());
...
<!--[if lte IE 8]>
		...
		<![endif]-->
<?php auto_complete();  ?>
<?= $this->load->view(ADMIN_FOLDER.'/shop/orderjs'); ?>
</head>
</head>
<body class="no-skin">
	...
	<form class="form-search">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Order<small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; New Order </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
          <div class="col-xs-12">
            <form class="form-horizontal"  name="formstock" id="formstock" action="<?php echo generateAdminForm("shop","placeorder",""); ?>" method="post" onSubmit="return ValidateForm()">
              <div class="row">
                <div class="col-xs-12">
                  <div class="clearfix">
                    <div class="row">
                      <div class="col-md-3">
                        <label> Name</label>
                        <input id="member_name" placeholder="Members" name="member_name"  class="col-xs-10 col-sm-12 validate[required] checkMinPvPrice" type="text" value="<?php echo $_REQUEST['member_name']; ?>">
                        <input type="hidden" name="member_id" id="member_id">
                      </div>
                      <div class="col-md-3">
                      <label>Branch</label>
                      <select name="franchisee_id" id="franchisee_id" class="col-xs-10 col-sm-12 validate[required]">
                      	<?php echo DisplayCombo($_REQUEST['franchisee_id'],"STORE_LOCATOR"); ?>
                      </select>
                ...
                <div class="clearfix">
				 ...
				 ?>
                            <tr>
                              ...
                              <td>
                              	<select class="col-xs-12 col-sm-12" id="post_attribute_id<?php echo $Li?>" name="post_attribute_id[]" style="width:auto;">
                                  <option value="">select attribute</option>
                                  <?php  #DisplayCombo($_REQUEST['post_attribute_id'],"ATTRIBUTE");  ?>
                                </select>
                              </td>
                              <td><div class="input-group"> <span class="input-group-addon"><i class="fa fa-inr"></i></span>
                                  <input id="post_mrp<?php echo $Li?>" placeholder="MRP Price" name="post_mrp[]"  class="col-xs-12 col-sm-12"  type="text" ref="<?php echo $Li?>" readonly>
                                </div></td>
                              ...
                              <td><div class="input-group"> <span class="input-group-addon"><i class="fa fa-inr"></i></span>
                                  <input id="post_price<?php echo $Li?>" placeholder="DP Price" name="post_price[]"  class="col-xs-12 col-sm-12 CalcTotal"  type="text" ref="<?php echo $Li?>">
                                </div></td>
                              <td><div class="input-group"> <span class="input-group-addon"><i class="fa fa-inr"></i></span>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="pull-right">
                        ...
                        <input type="hidden" name="min_sts" id="min_sts" value="0">
                        <button type="submit" name="submitOrder" value="1" class="btn btn-sm btn-success"> <i class="ace-icon fa fa-check"></i> Submit </button>
...
<script type="text/javascript">
	$(function(){
		...
		$(".checkMinPvPrice").on('blur',function(){
			var member_name = $("#member_name").val();
			if(member_name!=''){
				var data = {
					switch_type : "MINIMUM_PV",
					user_id : member_name
				};
				var URL_CART = "<?php echo BASE_PATH; ?>json/jsonhandler";
				$.getJSON(URL_CART,data,function(json_eval){	
					if(json_eval){
						$("#min_sts").val(json_eval.min_sts);
					}
				});
			}
		});
