...
$QR_PAGES="SELECT tr.* FROM tbl_rank AS tr WHERE  tr.rank_id>0 $StrWhr ORDER BY tr.rank_id ASC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Rank <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; List </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                      <tr class="<?php echo ($AR_DT['rank_sts']==0)? "text-danger":""; ?>">
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("setting","addrank",array("rank_id"=>_e($AR_DT['rank_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                              <li> <a onClick="return confirm('Make sure , you want to change this plan status?')" href="<?php echo generateSeoUrlAdmin("setting","addrank",array("rank_id"=>_e($AR_DT['rank_id']),"action_request"=>"STATUS","rank_sts"=>$AR_DT['rank_sts'])); ?>"><?php echo ($AR_DT['rank_sts']=="0")? "In-Active":"Active"; ?></a> </li>
                            </ul>
                          </div></td>
                      </tr>
