    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        ...
        <div class="row">
          ...
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal"  name="form-valid" id="form-valid" action="<?php echo generateAdminForm("setting","addfranchiseesetup",""); ?>" method="post">
              <div class="space-4"></div>
              <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Type :</label>
                <div class="col-sm-9">
                  <input id="form-field-1" placeholder="" name="franchisee_type"  class="col-xs-9 col-sm-6 validate[required]" type="text" value="<?php echo $ROW['franchisee_type']; ?>">
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-inr"></i></span>
                    <input id="discount_ratio" placeholder="" name="discount_ratio"  class="col-xs-6 col-sm-3 validate[required]"  type="text" value="<?php echo $ROW['discount_ratio']; ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="clearfix form-action">
                <div class="col-md-offset-3 col-md-9">
                  ...
                  <input type="hidden" name="fran_setup_id" id="fran_setup_id" value="<?php echo $ROW['fran_setup_id']; ?>">
                  ...
                  <button onClick="window.location.href='<?php echo generateSeoUrlAdmin("setting","franchiseesetup","");  ?>'"  class="btn" type="button"> <i class="ace-icon fa fa-undo bigger-110"></i> Cancel </button>
                </div>
              </div>
            </form>
            <!-- PAGE CONTENT ENDS --> 
