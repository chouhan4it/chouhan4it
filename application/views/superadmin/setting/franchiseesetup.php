...
$QR_PAGES="SELECT tsf.* FROM tbl_setup_franchisee AS tsf WHERE  tsf.delete_sts>0 $StrWhr ORDER BY tsf.fran_setup_id ASC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Branch <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Setup </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                      <tr class="<?php echo ($AR_DT['is_status']==0)? "text-danger":""; ?>">
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['fran_setup_id']; ?> <span class="lbl"></span> </label></td>
                        <td><?php echo $AR_DT['franchisee_type']; ?></td>
                        <td><?php echo $AR_DT['discount_ratio']; ?> <small>%</small></td>
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("setting","addfranchiseesetup",array("fran_setup_id"=>_e($AR_DT['fran_setup_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                              <li> <a onClick="return confirm('Make sure , you want to change this plan status?')" href="<?php echo generateSeoUrlAdmin("setting","addfranchiseesetup",array("fran_setup_id"=>_e($AR_DT['fran_setup_id']),"action_request"=>"STATUS","is_status"=>$AR_DT['is_status'])); ?>"><?php echo ($AR_DT['is_status']=="0")? "In-Active":"Active"; ?></a> </li>
                            </ul>
                          </div></td>
                      </tr>
