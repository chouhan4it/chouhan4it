...
$QR_PAGES="SELECT tf.* FROM tbl_faq AS tf   WHERE tf.faq_delete>0 $StrWhr ORDER BY tf.faq_id ASC";
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                      <tr>
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['faq_id']; ?> <span class="lbl"></span> </label></td>
