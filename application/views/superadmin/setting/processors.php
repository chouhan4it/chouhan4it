...
$QR_PAGES="SELECT tpp.* FROM tbl_payment_processor AS tpp   WHERE tpp.isDelete>0 $StrWhr ORDER BY tpp.processor_id ASC";
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                      <tr>
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['processor_id']; ?> <span class="lbl"></span> </label></td>
