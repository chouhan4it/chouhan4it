...
$QR_PAGES="SELECT tg.* FROM tbl_oprtr_grp AS tg WHERE  tg.group_id>0 $StrWhr ORDER BY tg.group_id ASC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Manage <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Group </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                      ...
                      <tr class="">
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("setting","group",array("group_id"=>_e($AR_DT['group_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                              <li> <a href="<?php echo generateSeoUrlAdmin("setting","group",array("group_id"=>_e($AR_DT['group_id']),"action_request"=>"DELETE")); ?>" onClick="return confirm('Make sure, want to delete this group')">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
