...
if($_REQUEST['from_date']!='' && $_REQUEST['to_date']!=''){
	...
	$StrWhr .=" AND DATE(tpm.date_time) BETWEEN '$from_date' AND '$to_date'";
	$SrchQ .="&from_date=$from_date&to_date=$to_date";
}


$QR_PAGES= "SELECT tpm.*, tpy.pin_name, tpy.pin_letter, tm.user_id FROM tbl_pinsmaster AS tpm 
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Generate <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; e-Pins </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th width="197">Plan type</th>
                        <th width="163">Transfer To</th>
                        <th width="133">No Of E-Pin </th>
                        <th width="133">Generate Date </th>
                        <th width="133">Payment Details </th>
			       ...
			       ?>
                      <tr>
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['mstr_id']; ?> <span class="lbl"></span> </label></td>
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("epin","viewpin",array("mstr_id"=>_e($AR_DT['mstr_id']),"action_request"=>"EDIT")); ?>">View</a> </li>
                              <li> <a href="<?php echo generateSeoUrlAdmin("epin","generate",array("mstr_id"=>_e($AR_DT['mstr_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
  ...
  <div id="search-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("epin","pingenerate","");  ?>" method="post">
