...
if($_REQUEST['member_id']!=''){
	...
	$StrWhr .=" AND ( tpd.from_member_id='$member_id' OR tpd.to_member_id='$member_id' )";
	$SrchQ .="&member_id=$member_id";
}


$QR_PAGES= "SELECT tpd.*, tmf.user_id AS from_user_id,  tmt.user_id AS to_user_id, tmu.user_id AS use_user_id , 
			tpy.pin_name
			FROM ".prefix."tbl_pinsdetails AS tpd 
			LEFT JOIN ".prefix."tbl_members AS tmf ON tpd.from_member_id=tmf.member_id
			LEFT JOIN ".prefix."tbl_members AS tmt ON tpd.to_member_id=tmt.member_id
			LEFT JOIN ".prefix."tbl_members AS tmu ON tpd.use_member_id=tmu.member_id
			LEFT JOIN ".prefix."tbl_pintype AS tpy ON tpd.type_id=tpy.type_id 
			WHERE tpd.from_member_id>0 AND tpd.to_member_id>0  $StrWhr 
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> E-pin <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Transfer </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
              ...
              <div class="col-xs-12">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("epin","pintransfer",""); ?>" method="post">
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                      <tr>
                        ...
                        <td><?php echo getTool($AR_DT['use_user_id'],"N/A"); ?></td>
                      </tr>
