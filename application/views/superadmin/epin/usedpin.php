...
$QR_PAGES = "SELECT tpd.*, tm.member_id as member,  tm.user_id, tm.first_name, tm.last_name, tpy.pin_name, 
			...
			WHERE tpd.pin_sts='Y' AND tpd.use_member_id>0 $StrWhr ORDER BY tpd.pin_id ASC";
              ...
              <div class="col-xs-12">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("epin","usedpin",""); ?>" method="post">
                      <div class="modal-body">
                        <div class="form-group">
                          <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Assign To 	  :</label>
                          <div class="col-sm-7">
                            <input name="user_id" type="text" class="col-xs-12 col-sm-12" id="user_id" value="<?php echo $_REQUEST['user_id']; ?>" placeholder="Assign To">
                        ...
                        <div class="form-group">
                          <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> E-Pin Key 	  :</label>
                          <div class="col-sm-7">
                            <input name="pin_key" type="text" class="col-xs-12 col-sm-12" id="pin_key" value="<?php echo $_REQUEST['pin_key']; ?>" placeholder="E-Pin Number">
                          </div>
                        </div>
                      </div>
