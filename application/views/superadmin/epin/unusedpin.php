...
$QR_PAGES= "SELECT tpd.*, tm.user_id, tm.first_name, tm.last_name, tpy.pin_name
			...
			WHERE tpd.pin_sts='N'  $StrWhr ORDER BY tpd.pin_id ASC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> E-pin <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Un-Used </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
              ...
              <div class="col-xs-12">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("epin","unusedpin",""); ?>" method="post">
