    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1>Generate <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;  E-Pin</small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php  get_message(); ?>
          <div class="col-xs-12"> 
            ...
            <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("epin","pingenerate",""); ?>" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input name="user_id" type="text" class="col-xs-5 col-sm-5 validate[required]" id="user_id" value="<?php echo $ROW['user_id']; ?>" placeholder="">
