...
$QR_MSTR = "SELECT tpm.*, tpy.pin_name, tpy.pin_letter, tm.title, tm.user_id, tm.first_name, tm.last_name, tm.member_mobile, tm.member_phone,
			tm.current_address, tm.member_email, tb.bank_name FROM tbl_pinsmaster AS tpm 
        ...
        <div class="row">
          ...
          <div class="col-xs-12"> 
            ...
            <table width="600" border="0" align="center" cellpadding="5" cellspacing="0" >
              <tr>
                <td width="444">&nbsp;</td>
                <td width="76" align="right"><img src="<?php echo BASE_PATH; ?>setupimages/button_back.gif" alt="Back" width="50" height="20" border="0" align="right" class="pointer" onClick="window.location.href='<?php echo generateSeoUrlAdmin("epin","pingenerate",array("")); ?>'" /></td>
