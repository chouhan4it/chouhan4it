...
$QR_PAGES= "SELECT tpm.*, tpy.pin_name, tpy.pin_letter, tf.store 
			...
			LEFT JOIN tbl_franchisee AS tf ON tf.franchisee_id=tpm.franchisee_id
			 WHERE tpm.franchisee_id>0 $StrWhr ORDER BY tpm.mstr_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Generate <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; e-Pins branch </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                      ...
                      <tr>
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("epin","viewpinfran",array("mstr_id"=>_e($AR_DT['mstr_id']),"action_request"=>"EDIT")); ?>">View</a> </li>
                              <li> <a href="<?php echo generateSeoUrlAdmin("epin","generatefran",array("mstr_id"=>_e($AR_DT['mstr_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
  ...
  <div id="search-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("epin","pingeneratefran","");  ?>" method="post">
