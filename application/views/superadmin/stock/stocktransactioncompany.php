...
if($_REQUEST['date_from']!='' && $_REQUEST['date_to']!=''){
	...
	$StrWhr .=" AND ( DATE(tw.order_date) BETWEEN '$date_from' AND '$date_to')";
	$SrchQ .="&date_from=$date_from&date_to=$date_to";
}
if($_REQUEST['order_no']!=''){
	$order_no = FCrtRplc($_REQUEST['order_no']);
	$StrWhr .=" AND tw.order_no='".$order_no."'";
	$SrchQ .="&order_no=$order_no";
}
$QR_PAGES= "SELECT twt.*,  SUM(twt.qty) AS sum_qty, SUM(twt.total) AS sum_total
			FROM tbl_warehouse_trns AS twt 
			WHERE  twt.warehouse_id>0  AND twt.trans_type LIKE 'Cr' $StrWhr 
			GROUP BY twt.ref_no
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1>Company Stock<small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Transaction </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
          <div class="col-xs-12">
            <div class="row">
              <div class="col-xs-12">
                <div class="clearfix">
                  <div class="row">
                    <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("stock","stocktransactioncompany",""); ?>" method="post">
                      <div class="col-md-4">
              ...
              <div class="clearfix">
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <th width="22" class="center"> <label class="pos-rel"> Srl No <span class="lbl"></span> </label>
                      </th>
                      <th width="201">Order No </th>
                      <th width="117">Quantity</th>
                  ...
                  <tbody>
			       ...
			       ?>
                    <tr class="<?php echo ($AR_DT['stock_sts']=="R")? "text-danger":""; ?>">
                      ...
                      <td><?php  echo number_format($AR_DT['sum_qty']);?></td>
                      <td><?php  echo number_format($AR_DT['sum_total'],2);?></td>
                      <td><?php echo $AR_DT['trans_date']; ?></td>
                      <td><div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-default">
                            <li> <a onClick="return confirm('Make sure, want to delete this stock entry')" href="<?php echo generateSeoUrlAdmin("stock","stockentrycompany",array("ref_no"=>_e($AR_DT['ref_no']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            <li> <a  href="<?php echo generateSeoUrlAdmin("stock","stockdetailcompany",array("ref_no"=>_e($AR_DT['ref_no']))); ?>">View</a> </li>
                          </ul>
                        </div></td>
                    </tr>
