...
<!--[if lte IE 8]>
		...
		<![endif]-->
<?php auto_complete();  ?>
<?= $this->load->view(ADMIN_FOLDER.'/stock/stockjs'); ?>
</head>
</head>
<body class="no-skin">
  ...
  <div class="main-content-inner">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
      <ul class="breadcrumb">
        ...
        <li class="active">&nbsp; Srock Entry</li>
      </ul>
      <!-- /.breadcrumb -->
    ...
    <div class="page-content">
      ...
      <div class="row">
        <?php get_message(); ?>
        <div class="col-xs-12">
          <form class="form-horizontal"  name="formstock" id="formstock" action="<?php echo generateAdminForm("stock","stockentry",""); ?>" method="post" onSubmit="return ValidateForm()">
            <div class="row">
              <div class="col-xs-12">
                <div class="clearfix">
                  <div class="row">
                    <div class="col-md-4">
                      <label>Branch</label>
                      <input id="franchisee_name_to" placeholder="Branch" name="franchisee_name_to"  class="col-xs-10 col-sm-12 validate[required]" type="text" value="<?php echo $_REQUEST['franchisee_name_to']; ?>">
                ...
                <table width="100%" class="table">
				 ...
				 ?>
                          <tr>
                            ...
                            <td><select class="col-xs-12 col-sm-12 stock_balance" id="post_attribute_id<?php echo $Li;?>" ref="<?php echo $Li;?>" name="post_attribute_id[]" style="width:auto;">
                                  <option value="">select attribute</option>
                                  <?php  #DisplayCombo($_REQUEST['post_attribute_id'],"ATTRIBUTE");  ?>
                                </select></td>
                            <td><input name="available_qty[]" type="text" class="col-xs-12 col-sm-12" id="available_qty<?php echo $Li;?>" ref="<?php echo $Li?>"  readonly="true" /></td>
                            ...
                            <td><input name="post_qty[]" type="text" class="col-xs-12 col-sm-12 CalcTotal checkQuantity" id="post_qty<?php echo $Li;?>" ref="<?php echo $Li;?>" />
                            </td>
                            <td><div class="input-group"> <span class="input-group-addon"><i class="fa fa-inr"></i></span>
                                <input id="post_dp_price<?php echo $Li;?>" placeholder="Price" name="post_dp_price[]"  class="col-xs-12 col-sm-12 CalcTotal"  type="text" ref="<?php echo $Li;?>">
                              </div></td>
                            <td><div class="input-group"> <span class="input-group-addon"><i class="fa fa-inr"></i></span>
                        ...
                        <div class="col-md-12">
						 <div class="space-4"></div>
                          <div class="form-group">
							...
							<div class="col-sm-2">
								<img src="<?php echo BASE_PATH; ?>setupimages/refresh2.png" alt="Refresh" align="absmiddle" id="NetCalcTotal"  style="cursor:pointer" />
							</div>
                          </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="pull-right">
                      ...
                      <input  type="hidden" id="net_post_pv"  name="net_post_pv" value="0"  >
