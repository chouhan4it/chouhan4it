...
$(function(){
	...
	$("input.prod_search").live('blur', function(){
		...
		var URL_LOAD = "<?php echo ADMIN_PATH; ?>json/jsonhandler?switch_type=SHOPPE_TO_COMPANY&q="+q+"&franchise_id="+franchisee_id_to.value;
