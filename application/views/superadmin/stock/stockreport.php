            ...
            <div class="row">
                    ...
                    <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("stock","stockreport",""); ?>" method="post">
                      ...
                      <div class="col-md-2">
                        <select name="franchisee_id" id="franchisee_id">
                          ...
                          <?php echo DisplayCombo($_REQUEST['franchisee_id'],"FRANCHISEE"); ?>
                        </select>
                      </div>
                      <div class="col-md-2">
                      ...
                      <div class="col-md-4">
                        ...
                        <a  class="btn btn-sm btn-info" href="<?php echo generateSeoUrlAdmin("excel","stockreport",""); ?>"> <i class="fa fa-file-excel-o"></i> Excel </a> </div>
                    </form>
                  </div>
                </div>
              </div>
              ...
              <div class="clearfix">
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <th width="22" class="center"> <label class="pos-rel"> Srl # <span class="lbl"></span> </label>
                      </th>
