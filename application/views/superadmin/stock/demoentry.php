...
<?php auto_complete();  ?>
<?php $this->load->view(ADMIN_FOLDER.'/stock/demostockjs'); ?>
</head>
<body class="no-skin">
	...
	<form class="form-search">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Demo Stock<small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Entry </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
          <div class="col-xs-12">
            <form class="form-horizontal"  name="formstock" id="formstock" action="<?php echo generateAdminForm("stock","demoentry",""); ?>" method="post" onSubmit="return ValidateForm()">
              <div class="row">
                <div class="col-xs-12">
                  <div class="clearfix">
                    <div class="row">
                      <div class="col-md-4">
                        <label>Name</label>
                        <input id="name_to" placeholder="Name of person" name="name_to"  class="col-xs-10 col-sm-12 validate[required]" type="text" value="<?php echo $_REQUEST['name_to']; ?>">
                      </div>
                      <div class="col-md-2">
                  ...
                  <table width="100%" class="table">
                    <tr>
                      <td colspan="4"><table class="table table-striped table-bordered table-hover" id="tblProdDtls" width="100%">
						...
						?>
                            <tr>
                              <td><input id="post_title<?php echo $Li?>" placeholder="" name="post_title[]"  class="col-xs-12 col-sm-12 prod_search" type="text" ref="<?php echo $Li?>" >
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="pull-right">
                        ...
                        <button type="submit" name="submitDemoStock" value="1" class="btn btn-sm btn-success"> <i class="ace-icon fa fa-check"></i> Submit </button>
