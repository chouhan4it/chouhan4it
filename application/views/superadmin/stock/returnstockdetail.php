...
$QR_MSTR =  "SELECT tsm.*, tf.name
			FROM tbl_stock_ledger AS tsm 
			LEFT JOIN tbl_franchisee AS tf ON tf.franchisee_id = tsm.franchisee_id
			WHERE tsm.ref_no='".$order_no."'
			ORDER BY tsm.trans_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1>Stock <small> <i class="ace-icon fa fa-angle-double-right"></i> Shoppe to Company Return Stock</small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php  get_message(); ?>
          <div class="col-xs-12"> 
            <!-- PAGE CONTENT BEGINS -->
            <table width="600" border="0" align="center" cellpadding="5" cellspacing="0"  class="table">
              <tr>
                <td width="444">&nbsp;</td>
                <td width="76" align="right"><img src="<?php echo BASE_PATH; ?>setupimages/button_back.gif" alt="Back" width="50" height="20" border="0" align="right" class="pointer" onClick="window.location.href='<?php echo generateSeoUrlAdmin("stock","stocktransaction",array("")); ?>'" /></td>
              ...
              <tr>
                <td colspan="3" align="center" class="cmntext" id="Letter"><table class="table" width="100%" border="0" cellpadding="5" cellspacing="0" style="border:1px solid #EBEBEB;">
                    ...
                    <tr>
                      <td width="42%" class="cmntext"><?php echo $AR_MSTR['name']; ?></td>
                      <td width="58%" rowspan="3" align="center">&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" valign="top" class="cmntext">To</td>
                    </tr>
                    <tr>
                      <td align="left" valign="top" class="cmntext">Company</td>
                    </tr>
                    <tr>
                      <td align="left" valign="top" class="cmntext"> Order No:
                        <?php  echo $AR_MSTR['ref_no']; ?>
                        <br />
                        Order Date:
                        <?php  echo $AR_MSTR['trans_date']; ?></td>
                    ...
                    <tr>
                      <td colspan="2" align="center" valign="top"><table class="table" width="100%" border="0" cellpadding="5" cellspacing="0" style="border:1px solid #EBEBEB;">
                          <tr>
                            ...
                            <td width="60%" align="left" class="cmntext"><strong>PRODUCT</strong></td>
                            <td width="10%" align="center" class="cmntext"><strong>DP</strong></td>
                            <td width="10%" align="center" class="cmntext"><strong>QTY</strong></td>
                            <td width="10%" align="center" class="cmntext"><strong>TOTAL</strong></td>
                          </tr>
                          <?php
						$Ctrl=1;
						$Q_STOCK = "SELECT tsm.*, tpl.post_title, tpl.post_price AS product_price FROM tbl_stock_ledger AS tsm 
						...
						$net_pay_amount +=$AR_STOCK['net_amount'];
						?>
                          <tr class="<?php echo ($AR_STOCK['stock_sts']=="R")? "text-danger":""; ?>">
                            ...
                            <td width="12%" align="center" class="cmntext"><?php echo number_format($AR_STOCK['trans_amount']);?></td>
                            <td width="19%" align="center" class="cmntext"><?php echo $AR_STOCK['trans_qty'];?></td>
                            <td width="19%" align="center" class="cmntext"><strong><?php echo number_format($AR_STOCK['net_amount']);?></strong></td>
                          </tr>
                          <?php 
						$Ctrl++;
						} 
						?>
                          ...
                          <tr>
                            <td colspan="5" align="right" class="cmntext"><strong>(Rupees <?php echo convert_number($net_pay_amount);?> Only)</strong></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
