...
if($_REQUEST['date_from']!='' && $_REQUEST['date_to']!=''){
	...
	$StrWhr .=" AND ( DATE(tsm.order_date) BETWEEN '$date_from' AND '$date_to')";
...
$QR_PAGES= "SELECT tsm.*, tf.name AS franchisee_name_from, ttf.name AS franchisee_name_to
			...
			WHERE  tsm.stock_id>0 AND tsm.franchisee_id_from=0 $StrWhr 
			GROUP BY tsm.order_no
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Stock<small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Transaction </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
          <div class="col-xs-12">
            <div class="row">
              <div class="col-xs-12">
                <div class="clearfix">
                  <div class="row">
                    <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("stock","stocktransaction",""); ?>" method="post">
                      <div class="col-md-4">
                  ...
                  <tbody>
			       ...
			       ?>
                    <tr class="<?php echo ($AR_DT['stock_sts']=="R")? "text-danger":""; ?>">
                      <td class="center"><label class="pos-rel"> <?php echo $AR_DT['stock_id']; ?> <span class="lbl"></span> </label></td>
                      <td><?php echo $AR_DT['order_no']; ?></td>
                      <td><?php echo ($AR_DT['franchisee_name_from'])? $AR_DT['franchisee_name_from']:"COMPANY / PGVPL"; ?></td>
                      <td><?php echo $AR_DT['franchisee_name_to']; ?></td>
                      <td><?php  echo stockStatus($AR_DT['stock_sts']);?></td>
                      ...
                      <td><div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-default">
                            ...
                            <li> <a onClick="return confirm('Make sure, want to delete this stock entry')" href="<?php echo generateSeoUrlAdmin("stock","stockentry",array("order_no"=>_e($AR_DT['order_no']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            <li> <a  href="<?php echo generateSeoUrlAdmin("stock","stockreverse",array("order_no"=>_e($AR_DT['order_no']))); ?>">Reverse Stock</a> </li>
                            <?php if($AR_DT['stock_sts']=="P"  || $AR_DT['stock_sts']==""){ ?>
                            <li> <a onClick="return confirm('Make sure, want to confirm this stock')" href="<?php echo generateSeoUrlAdmin("stock","stockentry",array("order_no"=>_e($AR_DT['order_no']),"stock_sts"=>"C","action_request"=>"STATUS")); ?>">Confirm</a> </li>
                            <li> <a onClick="return confirm('Make sure, want to reject this stock')" href="<?php echo generateSeoUrlAdmin("stock","stockentry",array("order_no"=>_e($AR_DT['order_no']),"stock_sts"=>"R","action_request"=>"STATUS")); ?>">Reject</a> </li>
                            <?php }} ?>
                            <li> <a href="<?php echo generateSeoUrlAdmin("stock","stockdetail",array("stock_id"=>_e($AR_DT['stock_id']))); ?>">View</a> </li>
                          </ul>
                        </div></td>
                    </tr>
