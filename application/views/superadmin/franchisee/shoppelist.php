...
$QR_PAGES="SELECT tf.*, tsf.franchisee_type
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Shoppe <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Offer Report </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
              ...
              <div class="col-xs-12">
                ...
                <div style="min-height:500px;">
                  <table id="" class="table">
			       ...
			       ?>
                      <tr class="">
                        <td width="22" rowspan="2" class="center"><label class="pos-rel"> <?php echo $AR_DT['franchisee_id']; ?> <span class="lbl"></span> </label></td>
                        ...
                        <td width="164"><?php echo $AR_DT['franchisee_type']; ?></td>
                        <td width="90" rowspan="2"><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("franchisee","shoppereport",""); ?>?franchisee_id=<?php echo $AR_DT['franchisee_id']; ?>">Offer Report</a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <tr>
