    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Shoppe <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; ALL Offer Report </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
          <div class="col-xs-12">
            <div class="row">
              <div class="col-xs-12">
                <div class="clearfix">
                  <div class="row">
                    <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("franchisee","shoppereport",""); ?>?franchisee_id=<?php echo $franchisee_id;?>" method="post">
                      <div class="col-md-2">
                ...
                <div class="col-xs-12">
                  <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered table-hover">
                    <tr style="font-weight:bold; font-size:18px;">
                      <td colspan="4">Shoppe Name: <?php echo $AR_SHOPPE['name'];?></td>
                      <td colspan="3">City: <?php echo $AR_SHOPPE['city'];?></td>
                      <td colspan="3" align="right"><a onClick="window.print()" aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-print btn btn-white btn-primary btn-bold"><span><i class="fa fa-print bigger-110 grey"></i> <span class="hidden">Print</span></span></a></td>
                    </tr>
					...
					$QR_OFFER = "SELECT A.post_id, A.post_mrp, A.post_discount, A.post_price, C.offer_module, C.offer_title, C.offer_expiry, 
								 C.offer_price FROM tbl_post_lang AS A, tbl_offer_product AS B, tbl_offer AS C WHERE A.post_id=B.post_id AND 
								 B.offer_id='$AR_DT[offer_id]' AND B.offer_id=C.offer_id";
					...
					if($AR_OFFER['offer_module']=='OPOF'){
					...
					}elseif($AR_OFFER['offer_module']=='OPOF-M'){
						$amount_collected = ($AR_OFFER['post_discount']*$total_count);
						...
						$total_collect = $model->getOfrSaleByFra('icoll',$AR_SHOPPE['franchisee_id'],$AR_DT['offer_id']);
						$amount_collected = $total_collect;
					}else{
                    ...
                    <tr>
                      ...
                      <td><div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-default">
                            <li> <a href="<?php echo generateSeoUrlAdmin("shop","viewofferreport","");?>?franchisee_id=<?php echo $franchisee_id;?>&offer_id=<?php echo $AR_DT['offer_id']; ?>">View</a> </li>
                            <li> <a href="javascript:void(0)" class="modal-offerproduct" franchisee_id="<?php echo $franchisee_id; ?>" offer_id="<?php echo $AR_DT['offer_id']; ?>">Product List</a> </li>
                          </ul>
                        </div></td>
                    </tr>
                    <?php 
...
<div class="modal" id="modal-offerproduct-detail"  aria-hidden="true">
  <div class="modal-dialog" style="width:800px;">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title">Ranks Differential Income</h4>
      </div>
            ...
            <div class="input-box frontForms">
              <div class="row">
                <div class="col-md-12 col-xs-12">
                  <div class="load-offerproduct"></div>
                </div>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
	$(function(){
		...
		$(".modal-offerproduct").on('click',function(){
			var offer_id = $(this).attr("offer_id");
			var franchisee_id = $(this).attr("franchisee_id");
			var URL_GET = "<?php echo generateSeoUrl("json","jsonhandler",""); ?>";
			$.post(URL_GET,{switch_type:"OFFER_PRODUCT",offer_id:offer_id,franchisee_id:franchisee_id},function(JsonEval){
				$(".load-offerproduct").html(JsonEval);
				$("#modal-offerproduct-detail").modal({
					backdrop: 'static',
					keyboard: false
				});
			});
