...
$QR_PAGES="SELECT tcf.* ,  tf.name, tf.user_name, tsf.franchisee_type
		 FROM  tbl_cmsn_franchise AS tcf	
		 LEFT JOIN tbl_franchisee AS tf ON tf.franchisee_id=tcf.franchisee_id
		 LEFT JOIN  tbl_setup_franchisee AS tsf  ON tsf.fran_setup_id=tf.fran_setup_id
		 WHERE tf.is_delete>0 AND tf.franchisee_id>1   $StrWhr ORDER BY tf.franchisee_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Shoppe <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Commission </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                  ...
                  <table id="" class="table">
                    <thead>
                      <tr>
                        <td>Cycle No </td>
                        <td>Franchise</td>
                        <td>Own Product Colection </td>
                        <td>Tie Up Product Collection </td>
			       ...
			       ?>
                      <tr>
                        <td width="143"><?php echo $AR_DT['process_id']; ?></td>
                        <td width="143"><?php echo $AR_DT['user_name']; ?></td>
                        <td width="134"><?php echo number_format($AR_DT['own_product_coll'],2); ?></td>
                        <td width="158"><?php echo number_format($AR_DT['tie_up_product_coll'],2); ?></td>
                        <td width="164"><?php echo number_format($AR_DT['amount'],2); ?></td>
                        <td width="165"><?php echo number_format($AR_DT['tds'],2); ?></td>
                        <td width="146"><?php echo number_format($AR_DT['admin_charge'],2); ?></td>
                        <td width="146"><?php echo number_format($AR_DT['net_cmsn'],2); ?></td>
                        <td width="146"><?php echo $AR_DT['date_time']; ?></td>
                      </tr>
                      <?php $Ctrl++; endforeach; }else{ ?>
                      <tr>
                        <td colspan="9" class="center text-danger"><i class="ace-icon fa fa-times bigger-110 red"></i> &nbsp; No commission found</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo ADMIN_PATH."member/profilelist"; ?>" method="post">
          <div class="modal-body">
            <div class="form-group">
              <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Franchise :</label>
              <div class="col-sm-7">
                <input id="form-field-1" placeholder="Name / Username" name="fullname"  class="col-xs-10 col-sm-12 validate[required]" type="text" value="<?php echo $_REQUEST['fullname']; ?>">
              </div>
            </div>
          </div>
