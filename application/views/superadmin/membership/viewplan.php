...
$QR_PAGES="SELECT tp.* FROM tbl_package AS tp	 WHERE tp.delete_sts>0  AND tp.package_id>0 $StrWhr ORDER BY tp.package_id ASC";
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th width="201">Plan Name</th>
                        <th width="116">Plan Charge </th>
                        <th width="117">CCL</th>
                        <th width="99">Mth. Rent Chrg. </th>
                        <th width="97">Yr. Rent Chrg. </th>
                        <th width="100">Interest CCL / Month </th>
                        <th width="106">Maximum CCL </th>
                        <th width="106">Amt Rec. Maximum Trns. </th>
                        <th width="106">Maximum Limit a Day Receving </th>
                        <th width="106">Maximum Trns on day </th>
			       ...
			       ?>
                      <tr class="<?php echo ($AR_DT['status']==0)? "text-danger":""; ?>">
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['package_id']; ?> <span class="lbl"></span> </label></td>
                        <td><?php echo $AR_DT['package_name']; ?> [&nbsp;&nbsp;<?php echo DisplayText("JOIN_".$AR_DT['package_type']); ?>&nbsp;&nbsp;]</td>
                        <td><?php echo $AR_DT['package_ccl']; ?></td>
                        <td><?php echo $AR_DT['package_ccl']; ?></td>
                        <td><?php echo $AR_DT['monthly_rent']; ?></td>
                        <td><?php echo $AR_DT['yearly_rent']; ?></td>
                        <td><?php echo $AR_DT['int_ccl_month']; ?></td>
                        <td><?php echo $AR_DT['max_ccl']; ?></td>
                        <td><?php echo $AR_DT['max_transaction']; ?></td>
                        <td><?php echo $AR_DT['max_limit_receive']; ?></td>
                        <td><?php echo $AR_DT['max_trns_day']; ?></td>
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              ...
                              <li> <a onClick="return confirm('Make sure , you want to change this plan status?')" href="<?php echo generateSeoUrlAdmin("membership","addplan",array("package_id"=>$AR_DT['package_id'],"action_request"=>"STATUS","status"=>$AR_DT['status'])); ?>"><?php echo ($AR_DT['status']=="0")? "In-Active":"Active"; ?></a> </li>
                      ...
                      <tr>
                        <td colspan="12" class="center text-danger"><i class="ace-icon fa fa-times bigger-110 red"></i> &nbsp; No record found</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
