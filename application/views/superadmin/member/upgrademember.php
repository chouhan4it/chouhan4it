    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Membership <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Upgrade </small> </h1>
        </div>
        <div class="row">
          <?php  get_message(); ?>
          <div class="col-xs-12" style="min-height:500px;">
            <form class="form-horizontal"   name="form-valid" id="form-valid" action="<?php echo generateAdminForm("member","upgrademember","");  ?>" method="post" >
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Rank: </label>
                <div class="col-sm-9">
                  <select class="col-xs-10 col-sm-5 validate[required]" name="rank_id" id="rank_id">
                    <option value="" selected="selected">---select----</option>
                    <?php echo DisplayCombo($rank_id,"RANK"); ?>
                  </select>
                </div>
              </div>
