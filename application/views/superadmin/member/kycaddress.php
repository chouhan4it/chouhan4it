...
$QR_PAGES = "SELECT kyc.*, tm.user_id, CONCAT_WS(' ',tm.first_name,tm.last_name) AS full_name,
		   ...
		   WHERE kyc.kyc_id>0 AND kyc.file_address!=''
		   $StrWhr ORDER BY kyc.kyc_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Member  KYC Verification<small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Address Verification </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php  get_message(); ?>
