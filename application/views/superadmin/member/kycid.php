...
if($_REQUEST['approved_sts']!=''){
	...
	$StrWhr .=" AND (  kyc.approved_sts_id='$approved_sts' )";	
...
$QR_PAGES = "SELECT kyc.*, tm.user_id, CONCAT_WS(' ',tm.first_name,tm.last_name) AS full_name,
		   ...
		   WHERE kyc.kyc_id>0  AND kyc.file_passport!='' $StrWhr ORDER BY kyc.kyc_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Member  KYC Verification<small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; ID Proof </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php  get_message(); ?>
          <div class="col-xs-12">
			...
			?>
              <tr class=""  style="cursor:pointer">
                ...
                <td height="20" align="center" valign="middle" class="cmntext"><a class="thumbnail" href="#thumb"><img src="<?php echo $profile_photo; ?>" class="img-circle" width="60px" height="60px" /><span><img src="<?php echo $profile_photo; ?>" /></span></a></td>
              ...
              <?php }else{?>
              <tr>
                <td colspan="5" align="center" class="errMsg">No kyc  found for this member <a href="<?php echo generateSeoUrlAdmin("member","profilelist",""); ?>">&lt; &lt; Back</a></td>
              </tr>
              <?php } ?>
            </table>
            <ul class="pagination">
