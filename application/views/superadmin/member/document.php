...
if($_REQUEST['member_id']!=''){
	...
	$StrWhr .=" AND tmd.member_id='$member_id'";
	$SrchQ .="&member_id=$member_id";
}

$QR_PAGES = "SELECT tmd.* , tm.user_id, tm.full_name
			FROM tbl_mem_doc AS tmd 
			LEFT JOIN tbl_members AS tm ON tmd.member_id=tm.member_id
			WHERE tmd.delete_sts>0 $StrWhr ORDER BY tmd.document_id DESC";
...
<script type="text/javascript">
	$(function(){
		...
		$(".updateStatus").on('click',function(){
			...
			var URL_LOAD = "<?php echo ADMIN_PATH."json/jsonhandler"; ?>?switch_type=DOCUMENT&document_id="+document_id;
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Member <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Document </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th width="157" align="center">Document</th>
                        <th width="157" align="center">Type</th>
                        <th width="157" align="center">Size</th>
			       ...
			       ?>
                        <tr>
                          <td class="center"><label class="pos-rel"> <?php echo $AR_DT['document_id']; ?> <span class="lbl"></span> </label></td>
                          <td align="left"><a href="javascript:void(0)"><?php echo $AR_DT['full_name']; ?>[<?php echo $AR_DT['user_id']; ?>]</a></td>
                          <td align="left"><?php echo $AR_DT['file_name']; ?></td>
                          <td align="left"><?php echo $AR_DT['file_type']; ?></td>
                          <td align="left"><?php echo $AR_DT['file_size']; ?></td>
                          <td align="left"><?php echo DisplayDate($AR_DT['date_time']); ?></td>
                          <td align="center"><a target="_blank" href="<?php echo  $model->documentLink($AR_DT['document_id']); ?>"><i class="fa fa-download"></i></a> &nbsp;&nbsp; <a onClick="return confirm('Make sure, want to delete this document?')" 
								href="<?php echo generateSeoUrlAdmin("member","document",array("document_id"=>_e($AR_DT['document_id']),"action_request"=>"DELETE")); ?>"><i class="fa fa-trash"></i></a></td>
                        </tr>
                        <?php $Ctrl++; endforeach; ?>
                        <?php  }else{ ?>
                        <tr>
  ...
  <div id="search-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("member","document",""); ?>" method="post">
