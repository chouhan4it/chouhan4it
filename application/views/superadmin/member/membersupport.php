...
$QR_PAGES="SELECT ts.*, tm.first_name, tm.last_name, tm.user_id, tm.city_name, tm.state_name, tsr.enquiry_reply,  tsr.reply_date AS update_date
			FROM tbl_support AS ts 
			LEFT JOIN tbl_members AS tm ON ts.from_id=tm.member_id 
			LEFT JOIN tbl_support_rply AS tsr ON tsr.enquiry_id=ts.enquiry_id
			WHERE tsr.reply_id = (SELECT MAX(reply_id) FROM tbl_support_rply WHERE enquiry_id=ts.enquiry_id)
			$StrWhr 
			GROUP BY ts.enquiry_id
			ORDER BY ts.reply_date DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Member <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Support </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr role="row">
                        <th   colspan="1" rowspan="1"  tabindex="0" class="">Ticket</th>
                        <th   rowspan="1"  tabindex="0">Member</th>
                        <th rowspan="1"  tabindex="0">Member Id </th>
                        <th rowspan="1"  tabindex="0">City </th>
                        <th rowspan="1"  tabindex="0">State</th>
                        <th  colspan="1" rowspan="1"  tabindex="0">Status</th>
                        <th   colspan="1" rowspan="1"  tabindex="0">Date</th>
                        <th   rowspan="1"  tabindex="0">Message </th>
					...
					?>
                      <tr class="odd" role="row">
                        ...
                        <td><?php echo getDateFormat($AR_DT['update_date'],"d M Y h:i"); ?></td>
                        <td><?php echo $AR_DT['enquiry_reply']; ?></td>
                        <td><a href="<?php echo generateSeoUrlAdmin("member","conversation",array("enquiry_id"=>_e($AR_DT['enquiry_id']))); ?>"> <img src="<?php echo BASE_PATH; ?>assets/img/policyicon.gif" id="<?php echo $AR_DT['enquiry_id']; ?>" class="viewChat pointer"> </a>&nbsp;&nbsp; </td>
                      </tr>
                      <?php endforeach;
								}
								 ?>
