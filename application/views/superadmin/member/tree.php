...
if($Var1!=""){
	$QR_TREE1 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var1' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var2!=""){
	$QR_TREE2 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var2' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var3!=""){
	$QR_TREE3 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var3' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var4!=""){
	$QR_TREE4 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var4' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var5!=""){
	$QR_TREE5 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var5' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var6!=""){
	$QR_TREE6 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var6' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var7!=""){
	$QR_TREE7 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var7' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var8!=""){
	$QR_TREE8 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var8' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var9!=""){
	$QR_TREE9 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var9' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var10!=""){
	$QR_TREE10 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var10' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var11!=""){
	$QR_TREE11 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var11' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var12!=""){
	$QR_TREE12 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var12' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var13!=""){
	$QR_TREE13 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var13' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var14!=""){
	$QR_TREE14 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var14' AND (tree.nleft>0 AND tree.nright>0) ";
...
if($Var15!=""){
	$QR_TREE15 = "SELECT tree.* FROM tbl_mem_tree AS tree 
				LEFT JOIN tbl_members AS tm ON tree.member_id=tm.member_id
				WHERE tm.delete_sts>0 AND tree.spil_id = '$Var15' AND (tree.nleft>0 AND tree.nright>0) ";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Member <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;  Matching Tree</small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php  get_message(); ?>
          <div class="col-xs-12"> 
            ...
            <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
              ...
              <tr bgcolor="#FFFFFF">
                <td colspan="8" align="center" valign="top"><?php $model->getNameStatus($Var2, $Var1, "L");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenMid.gif"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td width="1" rowspan="4" align="center" valign="top" style="background-image:url(<?php echo BASE_PATH; ?>assets/setupimages/arrow.gif)">&nbsp;</td>
                <td colspan="8" align="center" valign="top"><?php $model->getNameStatus($Var3, $Var1, "R");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenMid.gif"  /></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="77" colspan="4" align="center" valign="top"><?php $model->getNameStatus($Var4, $Var2, "L"); ?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif"  /></td>
                <td colspan="4" align="center" valign="top"><?php $model->getNameStatus($Var5, $Var2, "R"); ?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif"  /></td>
                <td colspan="4" align="center" valign="top"><?php $model->getNameStatus($Var6, $Var3, "L");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif"  /></td>
                <td colspan="4" align="center" valign="top"><?php $model->getNameStatus($Var7, $Var3, "R");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif"  /></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="" colspan="2" align="center" valign="top"><?php $model->getNameStatus($Var8, $Var4, "L");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif" /></td>
                <td colspan="2" align="center" valign="top"><?php $model->getNameStatus($Var9, $Var4, "R");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif"  /></td>
                <td colspan="2" align="center" valign="top"><?php $model->getNameStatus($Var10, $Var5, "L");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif"  /></td>
                <td colspan="2" align="center" valign="top"><?php $model->getNameStatus($Var11, $Var5, "R");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif" /></td>
                <td colspan="2" align="center" valign="top"><?php $model->getNameStatus($Var12, $Var6, "L");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif" /></td>
                <td colspan="2" align="center" valign="top"><?php $model->getNameStatus($Var13, $Var6, "R");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif"  /></td>
                <td colspan="2" align="center" valign="top"><?php $model->getNameStatus($Var14, $Var7, "L");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif"  /></td>
                <td colspan="2" align="center" valign="top"><?php $model->getNameStatus($Var15, $Var7, "R");?>
                  <br>
                  <img src="<?php echo BASE_PATH; ?>setupimages/GenSmal.gif"  /></td>
              </tr>
              ...
              <tr bgcolor="#FFFFFF">
                <td colspan="17" align="left" valign="middle" class="boldtext"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr bgcolor="#FFFFFF">
                      <td width="40%" align="right" valign="middle"><input name="user_id" type="text" class="cmnfld" id="user_id" value="" />
                        &nbsp;&nbsp;
                        <input name="member_id" type="hidden" id="member_id" value="" /></td>
                      <td width="60%" align="left" valign="middle"><input name="ViewTree" type="button" class="btn btn-success btn-sm" id="ViewTree" onClick="SearchTree()" value="View Tree" />
                        <input name="Back" type="button" class="btn btn-danger btn-sm" id="Back" onClick="GoBack()" value="&lt;&lt;Back" />
                        
                        <!--<input name="TopTree" type="button" class="btn_new_admin" id="TopTree" onClick="ViewTop()" value="Top Tree" />-->
                        
                        <input name="FullScreen" type="button" class="btn btn-info btn-sm" id="FullScreen" onClick="OpenPage('<?php echo $_SERVER['REQUEST_URI']; ?>', 'BinaryTree','700', '600', '10', '10', '1','1')" value="View Full Screen" /></td>
                    </tr>
                    <tr bgcolor="#FFFFFF">
                      <td colspan="2" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td height="26" colspan="3"><span class="cmntext"><img src="<?php echo BASE_PATH; ?>setupimages/sample1_sub_arrow.gif" alt="Arrow" width="14" height="14" align="left" /></span><span class="bluetext">Click on Member id to view Binary Tree </span></td>
                            <td height="26" colspan="3"><span class="bluetext"><img src="<?php echo BASE_PATH; ?>setupimages/sample1_sub_arrow.gif" alt="Arrow" width="14" height="14" align="left" />Click on Member icon to view  Binary Statistics</span></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
