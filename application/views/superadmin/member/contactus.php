...
if($_REQUEST['name']!=''){
	...
	$StrWhr .=" AND ( tc.name LIKE '%$name%' OR tc.mobile LIKE '%$name%' OR tc.email LIKE '%$name%')";
	$SrchQ .="&name=$name";
}
if($_REQUEST['from_date']!='' && $_REQUEST['to_date']!=''){
	$from_date = InsertDate($_REQUEST['from_date']);
	$to_date = InsertDate($_REQUEST['to_date']);
	$StrWhr .=" AND DATE(tc.date_time) BETWEEN '$from_date' AND '$to_date'";
	$SrchQ .="&from_date=$from_date&to_date=$to_date";
}


$QR_PAGES="SELECT tc.* , tm.first_name, tm.last_name, tm.user_id FROM tbl_contacts AS tc 
			LEFT JOIN tbl_members AS tm ON tm.member_id=tc.member_id	
			WHERE 1 $StrWhr ORDER BY tc.contact_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Website <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Contact-us </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th width="163">Email</th>
                        <th width="133">Phone </th>
                        <th width="133">Subject </th>
                        <th width="109">IP</th>
			       ...
			       ?>
                      <tr>
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['contact_id']; ?> <span class="lbl"></span> </label></td>
                        <td><?php echo $AR_DT['name']; ?></td>
                        <td><?php echo $AR_DT['email']; ?></td>
                        <td><?php echo $AR_DT['mobile']; ?></td>
                        <td><?php echo $AR_DT['subject']; ?></td>
                        <td><a target="_blank" href="http://www.iptrackeronline.com/index.php?ip_address=<?php echo $AR_DT['visitor_ip']; ?>"><?php echo $AR_DT['visitor_ip']; ?></a></td>
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a onClick="return confirm('Make sure , you want to delete this contact?')" href="<?php echo generateSeoUrlAdmin("member","contactus",array("contact_id"=>_e($AR_DT['contact_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <tr>
                        <td class="center">&nbsp;</td>
                        <td colspan="7">Message: <?php echo $AR_DT['message']; ?></td>
                      </tr>
  ...
  <div id="search-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo ADMIN_PATH."member/contactus"; ?>" method="post">
          <div class="modal-body">
            <div class="form-group">
              <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Name / Email  :</label>
              <div class="col-sm-7">
