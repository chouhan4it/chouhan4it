    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> View Member <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Transactions </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php  get_message(); ?>
          <div class="col-xs-12" style="min-height:500px;"> 
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo ADMIN_PATH."financial/viewtransactions"; ?>" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input id="form-field-1" placeholder="User Id" name="user_id"  class="col-xs-10 col-sm-5 validate[required]" type="text" value="<?php echo $ROW['user_id']; ?>">
