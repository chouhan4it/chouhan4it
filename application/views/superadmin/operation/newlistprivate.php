...
$QR_PAGES="SELECT tn.* FROM tbl_news AS tn   WHERE news_type LIKE 'PRIVATE'
		  AND  isDelete>0 $StrWhr ORDER BY tn.news_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> News(Pop up) <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; List </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th width="103" align="center">News Title</th>
                        <th width="81" align="center">Date</th>
                        <th width="254" align="center">Detail</th>
                        <th width="71" align="center">Access</th>
			       ...
			       ?>
                      <tr>
                        <td class="center"><?php echo $Ctrl; ?>
                          </label></td>
                        <td align="left"><a href="javascript:void(0)"><?php echo $AR_DT['news_title']; ?></a></td>
                        <td align="left"><?php echo DisplayDate($AR_DT['news_date']); ?></td>
                        <td align="left"><?php echo setWord(strip_tags($AR_DT['news_detail']),200); ?></td>
                        <td align="left"><?php echo ($AR_DT['checkallmember']>0)? "All":"Particular"; ?></td>
                        ...
                        <td align="center"><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("operation","newstomember",array("news_id"=>_e($AR_DT['news_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                              <li> <a onClick="return confirm('Make sure want to delete this record?')" href="<?php echo generateSeoUrlAdmin("operation","newstomember",array("news_id"=>_e($AR_DT['news_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <?php $Ctrl++; endforeach; ?>
  ...
  <div id="search-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("operation","newlistprivate","");  ?>" method="post">
