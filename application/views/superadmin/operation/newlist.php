...
$QR_PAGES="SELECT tn.* FROM tbl_news AS tn   WHERE news_type LIKE 'PUBLIC'
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> News <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; List </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    ...
                    <form method="post" autocomplete="off" action="<?php echo ADMIN_PATH."operation/news"; ?>">
                      <tbody>
                        <?php 
			 	 	if($PageVal['TotalRecords'] > 0){
				  		$Ctrl=$PageVal['RecordStart']+1;
						foreach($PageVal['ResultSet'] as $AR_DT):
							$IMG_NEWS = $model->getNewsImage($AR_DT['news_id']);
			       ?>
                        <tr>
                          <td class="center"><?php echo $Ctrl; ?></td>
                          <td align="left"><img src="<?php echo $IMG_NEWS; ?>" width="60" height="40"></td>
                          <td align="left"><?php echo $AR_DT['news_title']; ?></td>
                          ...
                          <td align="center"><div class="btn-group">
                              ...
                              <ul class="dropdown-menu dropdown-default">
                                <li> <a href="<?php echo generateSeoUrlAdmin("operation","news",array("news_id"=>_e($AR_DT['news_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                                <li> <a onClick="return confirm('Make sure want to delete this record?')" href="<?php echo generateSeoUrlAdmin("operation","news",array("news_id"=>_e($AR_DT['news_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                              </ul>
                            </div></td>
                        </tr>
                        <?php $Ctrl++; endforeach; ?>
  ...
  <div id="search-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("operation","newlist","");  ?>" method="post">
