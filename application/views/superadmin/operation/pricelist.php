...
$table_name = "tbl_setup_product_price";


$QR_PAGES="SELECT tspp.* FROM tbl_setup_product_price AS tspp   WHERE tspp.product_price_id>0 ORDER BY tspp.product_price_id ASC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Setup <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Price List </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th  align="center">Price From</th>
                        <th  align="center">Price To</th>
                        <th align="center">Price Ratio (%)</th>
                      </tr>
                    </thead>
			       ...
			       ?>
                        <tr>
                          ...
                          <td align="left"><?php echo get_input("text","product_price_from","product_price_from","enableText updateField",$AR_DT['product_price_from'],"Price From","","",$table_name,"product_price_from",$AR_DT['product_price_id']);  ?></td>
                          <td align="left"><?php echo get_input("text","product_price_to","product_price_to","enableText updateField",$AR_DT['product_price_to'],"Price To","","",$table_name,"product_price_to",$AR_DT['product_price_id']);  ?></td>
                          <td align="left"><?php echo get_input("text","product_price_ratio","product_price_ratio","enableText updateField",$AR_DT['product_price_ratio'],"Price Ratio %","","",$table_name,"product_price_ratio",$AR_DT['product_price_id']);  ?> %</td>
                        </tr>
                        <?php $Ctrl++; endforeach; ?>
                        <?php  }else{ ?>
                        <tr>
