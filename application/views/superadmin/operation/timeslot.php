...
$table_name = "tbl_sys_menu";


$QR_PAGES="SELECT tds.* FROM tbl_delivery_slot AS tds   WHERE tds.delivery_slot_id>0 ORDER BY tds.delivery_slot_id ASC";
$PageVal = DisplayPages($QR_PAGES, 5, $Page, $SrchQ);
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Delivery <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Slot </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th  align="center">Delivery Slot</th>
                      </tr>
                    </thead>
			       ...
			       ?>
                        <tr>
                          ...
                          <td align="left"><?php echo get_input("text","delivery_slot","delivery_slot","enableText updateField",$AR_DT['delivery_slot'],"Deliver Slot","","",$table_name,"delivery_slot",$AR_DT['delivery_slot_id']);  ?></td>
                        </tr>
                        <?php $Ctrl++; endforeach; ?>
                        <?php  }else{ ?>
                        <tr>
