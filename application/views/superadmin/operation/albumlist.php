...
if($_REQUEST['gallery_name']!=''){
	$gallery_name = FCrtRplc($_REQUEST['gallery_name']);
	$StrWhr .=" AND ( tg.gallery_name LIKE '%$gallery_name%' OR  tg.gallery_name LIKE '%$gallery_name%' )";
	$SrchQ .="&news_title=$news_title";
}

$QR_PAGES= "SELECT tg.* FROM tbl_gallery AS tg   WHERE tg.delete_sts>0 $StrWhr ORDER BY tg.gallery_id DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Album <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; List </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th width="103" align="center">Album Name</th>
                        <th width="81" align="center">Image</th>
                        <th width="81" align="center">Date</th>
			       ...
			       ?>
                      <tr>
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['gallery_id']; ?> <span class="lbl"></span> </label></td>
                        <td align="left"><a href="javascript:void(0)"><?php echo $AR_DT['gallery_name']; ?></a></td>
                        <td align="left"><img src="<?php echo $model->getAlbumImg($AR_DT['gallery_id']); ?>" width="60px" height="60px" class="img-responsive"></td>
                        <td align="left"><?php echo DisplayDate($AR_DT['date_time']); ?></td>
                        <td align="left"><?php echo setWord(strip_tags($AR_DT['gallery_detail']),200); ?></td>
                        <td align="left"><?php echo ($AR_DT['gallery_sts']>0)? "Active":"In-Active"; ?></td>
                        <td align="center"><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("operation","album",array("gallery_id"=>_e($AR_DT['gallery_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                              <li> <a onClick="return confirm('Make sure want to delete this record?')" href="<?php echo generateSeoUrlAdmin("operation","album",array("gallery_id"=>_e($AR_DT['gallery_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <?php $Ctrl++; endforeach; ?>
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo ADMIN_PATH."operation/cmslist"; ?>" method="post">
          <div class="modal-body">
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input id="form-field-1" placeholder="Title" name="news_title"  class="col-xs-10 col-sm-12 validate[required]" type="text" value="<?php echo $_REQUEST['news_title']; ?>">
              </div>
            </div>
          </div>
