...
$QR_PAGES="SELECT tt.*, CONCAT_WS(' ',tm.first_name,tm.last_name) AS full_name, tm.user_id, 
		  CONCAT_WS('',tm.mobile_code,tm.member_mobile) AS mobile_number , tm.city_name
		  FROM tbl_testimonial AS tt 
		  LEFT JOIN tbl_members AS tm ON tm.member_id = tt.member_id
		  WHERE 1 $StrWhr ORDER BY tt.testimonial_date DESC";
...
<script type="text/javascript">
	$(function(){
		...
		$(".checkStatus").on('click',function(){
			...
			var URL_LOAD = "<?php echo BASE_PATH."json/jsonhandler"; ?>?switch_type=TESTIMONIAL&testimonial_id="+testimonial_id;
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> User <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Testimonials</small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th align="center">Testimonial</th>
                        <th align="center">Displayed</th>
			       ...
			       ?>
                      <tr>
                        ...
                        <td align="left"><?php echo $AR_DT['user_id']; ?></td>
                        <td align="left"><?php echo $AR_DT['city_name']; ?></td>
                        <td align="left"><?php echo $AR_DT['testimonial_detail']; ?></td>
                        <td align="center"><label>
                            <input name="switch-field-1" testimonial_id="<?php echo $AR_DT['testimonial_id']; ?>" class="ace ace-switch ace-switch-4 checkStatus" <?php if($AR_DT['testimonial_sts']>0){ echo 'checked="checked"';} ?>  type="checkbox">
                        ...
                        <td align="center"><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a onClick="return confirm('Make sure want to delete this record?')" href="<?php echo generateSeoUrlAdmin("operation","testimonial",array("testimonial_id"=>_e($AR_DT['testimonial_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <?php $Ctrl++; endforeach; ?>
