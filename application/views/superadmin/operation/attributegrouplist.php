...
$QR_PAGES= "SELECT ta.* FROM tbl_attribute_group  AS ta  WHERE ta.delete_sts>0 $StrWhr ORDER BY ta.attribute_group_id ASC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Attribute Group<small> <i class="ace-icon fa fa-angle-double-right"></i>List </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                      <tr>
                        ...
                        <td><?php echo ($AR_DT['attribute_group_sts']=="1")? "Active":"In-Active"; ?></td>
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("operation","attribute",array("attribute_group_id"=>_e($AR_DT['attribute_group_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                              <li> <a onClick="return confirm('Make sure , you want to change this language status?')" href="<?php echo generateSeoUrlAdmin("operation","attribute",array("attribute_group_id"=>_e($AR_DT['attribute_group_id']),"action_request"=>"STATUS","attribute_group_sts"=>$AR_DT['attribute_group_sts'])); ?>"><?php echo ($AR_DT['attribute_group_sts']=="0")? "Activate":"De-Activate"; ?></a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <?php $Ctrl++; endforeach; } ?>
