...
if($_REQUEST['trns_status']!=''){
	$trns_status = FCrtRplc($_REQUEST['trns_status']);
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Report <small> <i class="ace-icon fa fa-angle-double-right"></i> PAYOUT REQUEST REPORT</small> </h1>
        </div>
        <!-- /.page-header -->
        ...
        <div class="row">
          ...
          <div class="col-xs-4">
            <div class="clearfix">
              <form id="form-search" name="form-search" method="get" action="<?php echo generateAdminForm("report","withdrawreport",""); ?>">
                <b>ORDER ID</b>
                ...
                <div class="form-group">
                  <div class="col-md-12">
                  	<label>
                    <input type="radio" name="trns_status" id="trns_status_c"  value="C">
                    <strong>Confirmed</strong></label> &nbsp;&nbsp;
                    <label>
                    <input type="radio" name="trns_status" id="trns_status_r" value="R"  >
                    <strong>Reject</strong></label>&nbsp;&nbsp;
                    <label>
                     <input type="radio" name="trns_status" id="trns_status_n" value="N"  >
                    <strong>Pending</strong></label>
                   </div>
                </div>
                <div class="clearfix">&nbsp;</div>
                ...
                <a href="<?php echo generateSeoUrlAdmin("report","withdrawreport",""); ?>"  class="btn btn-sm btn-danger m-t-n-xs" value=" Reset ">Reset</a>
              </form>
            </div>
          </div>
        </div>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered table-hover">
              ...
              <tr>
                ...
                <td><?php if($AR_DT['trns_status']=="C"){ ?>
                  <a href="javascript:void(0)" onClick="alert('Already confirmed')" class="text text-success arrowed-in arrowed-in-right">Confirmed</a>
                  <?php }elseif($AR_DT['trns_status']=="R"){ ?>
                  <a  href="javascript:void(0)" onClick="alert('Already rejected')"   class="text text-warning">Rejected</a>
                  <?php }else{ ?>
                  <a href="javascript:void(0)"  transfer_id="<?php echo _e($AR_DT['transfer_id']); ?>" class="text text-success open_modal">Confirm / Reject</a>
                  <?php } ?></td>
              ...
              <tr>
                <td colspan="14" class="text-danger">No transaction found </td>
              </tr>
              <?php } ?>
            </table>
            <ul class="pagination">
