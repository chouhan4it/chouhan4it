...
$QR_PAGES = "SELECT ord.*, CONCAT_WS(' ',tm.first_name,tm.last_name) AS full_name, tm.member_email, tm.user_id AS user_id ,tm.city_name, tm.state_name,
			 ...
			 tod.post_title, tod.post_desc, tod.post_qty AS order_qty, 
...
$QR_EXPORT = "SELECT ord.date_add AS order_date,
			 ord.order_no,
			 tf.name AS seller_name, 
			 tod.post_title AS order_detail,
			 tod.post_selling AS item_selling,
			 tod.post_cmsn AS item_cmsn, 
			 ord.tax_amount AS taxes, 
			 tod.post_price AS item_price
			 FROM tbl_orders AS ord
			 LEFT JOIN tbl_members AS tm ON tm.member_id=ord.member_id
			 LEFT JOIN tbl_order_detail AS tod ON tod.order_id=ord.order_id
			 LEFT JOIN tbl_franchisee AS tf ON tf.franchisee_id=ord.franchisee_id
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Order <small> <i class="ace-icon fa fa-angle-double-right"></i> Sales Report</small> </h1>
        </div>
        <!-- /.page-header -->
        ...
        <div class="row">
          ...
          <div class="col-xs-12">
            <div class="clearfix">
              <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("report","orderreport",""); ?>" method="post">
                <div class="row">
                  <div class="col-md-2">
          ...
          <div class="col-xs-12"> 
            ...
            <table  class="table">
             <thead>
              ...
              <tr>
                <td ><?php echo $Ctrl;?></td>
                <td ><?php echo DisplayDate($AR_DT['date_add']); ?></td>
