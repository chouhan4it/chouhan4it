...
if($_REQUEST['date_from']!='' && $_REQUEST['date_to']!=''){
	...
	$Q_Sales = "SELECT * FROM tbl_post_lang WHERE post_hsn!='' ORDER BY post_id ASC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Report <small> <i class="ace-icon fa fa-angle-double-right"></i> GST HSN Summary</small> </h1>
        </div>
        <!-- /.page-header -->
        ...
        <div class="row">
          ...
          <div class="col-xs-12">
            <div class="clearfix">
              <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("report","gsthsnreport",""); ?>" method="post">
                <div class="row">
                  <div class="col-md-2">
		...
		$Q_Offer = "SELECT COUNT(ord.order_detail_id) AS iCnt 
					FROM 
					tbl_order_detail AS ord 
					LEFT JOIN tbl_orders AS mstr ON mstr.order_id=ord.order_id 
					WHERE 1 
					AND ord.post_id='$AR_DT[post_id]' 
					AND ord.in_offer='Y'    
					AND DATE(mstr.invoice_date) BETWEEN '$date_from' AND '$date_to' 
					$StrWhr";
		$AR_Offer = $this->SqlModel->runQuery($Q_Offer,true);

		$Q_No_Offer = "SELECT COUNT(ord.order_detail_id) AS iCnt 
					   FROM 
					   tbl_order_detail AS ord 
					   LEFT JOIN tbl_orders AS mstr ON mstr.order_id=ord.order_id 
					   WHERE 1 
					   ...
					   AND DATE(mstr.invoice_date) BETWEEN '$date_from' AND '$date_to' 
					   $StrWhr";
		$AR_No_Offer = $this->SqlModel->runQuery($Q_No_Offer,true);
