...
<div class="wrapper">
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12">
        <h4 class="page-title">Matching Repurchase Bonus</h4>
        <p class="text-muted page-title-alt">Your Matching Repurchase Bonus</p>
      </div>
    </div>
    <!-- end row -->
    <div class="row">
            ...
            <div class="row"> <?php echo get_message(); ?>
              <div class="col-lg-12">
                <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="">
                  <div class="row">
                    <div class="col-md-12">
                      <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateMemberForm("report","binaryincomerepurchase",""); ?>" method="post" enctype="multipart/form-data">
