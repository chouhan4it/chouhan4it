<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	...
	$QR_PAGES= "SELECT tcr.*, tm.user_id, tm.full_name,
			    ...
			    WHERE tcr.member_id='".$member_id."' AND tcr.royalty_type='R2' $StrWhr ORDER BY tcr.royalty_cmsn_id DESC";
...
<div class="wrapper">
  <div class="container"> 
    ...
    <div class="row">
      <div class="col-sm-12">
        <h4 class="page-title">Royalty 2 Income</h4>
        <p class="text-muted page-title-alt">Your Royalty 2 Income</p>
      </div>
    </div>
    <!-- end row -->
    <div class="row"> 
            ...
            <div class="row"> <?php echo get_message(); ?>
              <div class="col-lg-12">
                <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="">
                  <div class="row">
                    <div class="col-md-12">
                      <form id="form-search" name="form-search" method="get" action="<?php echo generateMemberForm("report","royaltyincome2",""); ?>">
                        <b>Date </b>
