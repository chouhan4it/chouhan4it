...
$QR_PAGES= "SELECT tpd.*, tm.user_id, tm.first_name, tm.last_name, tpy.pin_name, 
			tpd.pin_price,	used.first_name AS use_first_name,
			used.last_name AS use_last_name, used.user_id AS use_user_id
			...
			LEFT JOIN tbl_pintype AS tpy ON tpd.type_id=tpy.type_id WHERE tpd.pin_sts='Y' 
			AND tpd.pin_id>0 AND tpd.use_member_id>0 AND ( tpd.member_id='".$member_id."'  ) 
			$StrWhr 
			GROUP BY tpd.pin_id
...
<div class="wrapper">
  <div class="container"> 
    ...
    <div class="row">
      <div class="col-sm-12">
        <h4 class="page-title">My Used Pin</h4>
        <p class="text-muted page-title-alt">Your Used Pin</p>
      </div>
    </div>
    <!-- end row -->
    <div class="row"> 
            ...
            <div class="row"> <?php echo get_message(); ?>
              <div class="col-lg-12">
                <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="">
                  <div class="row">
                    <div class="col-md-12">
                      <form id="form-search" name="form-search" method="get" action="<?php echo generateMemberForm("epin","usedpin",""); ?>">
                        <b>Package </b>
                        ...
                        <a href="<?php echo generateMemberForm("epin","usedpin",""); ?>"  class="btn btn-danger m-t-n-xs" value=" Reset ">Reset</a>
                      </form>
                    </div>
                  </div>
                  <div class="clearfix">&nbsp;</div>
