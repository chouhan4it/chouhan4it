...
$QR_PAGES= "SELECT tpd.*, tm.user_id, tm.first_name, tm.last_name, tpy.pin_name, tpd.transfer_date,
			...
			LEFT JOIN tbl_members AS tm ON tpd.to_member_id=tm.member_id
			LEFT JOIN tbl_pintype AS tpy ON tpd.type_id=tpy.type_id WHERE 
			tpd.member_id>0 AND tpd.from_member_id='".$member_id."'
			$StrWhr 
			GROUP BY tpd.pin_id
  ...
  <div class="container"> 
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <p class="text-muted page-title-alt">Your Send Pin</p>
      </div>
    </div>
    <!-- end row -->
    <div class="row"> 
            ...
            <div class="row"> <?php echo get_message(); ?>
              <div class="col-lg-12">
                <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="">
                  <div class="row">
                    <div class="col-md-12">
                      <form id="form-search" name="form-search" method="get" action="<?php echo generateMemberForm("epin","pinsend",""); ?>">
                        <b>Package </b>
                        ...
                        <a href="<?php echo generateMemberForm("epin","pinsend",""); ?>"  class="btn btn-danger m-t-n-xs" value=" Reset ">Reset</a>
                      </form>
                    </div>
                  </div>
                  <div class="clearfix">&nbsp;</div>
