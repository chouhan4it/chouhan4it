<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	...
	$AR_MEM = $model->getMember($member_id,$tree_type);
	
	
	$Q_GEN =  "SELECT nlevel, nleft, nright FROM ".$tree_table." WHERE member_id='".$member_id."'";
	...
	$QR_MEM = "SELECT tm.*, CONCAT_WS(' ',tmsp.first_name,tmsp.last_name) AS spsr_full_name,  tmsp.user_id AS spsr_user_id ,
			   ...
			   LEFT JOIN ".$tree_table." AS tree ON tm.member_id=tree.member_id
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card-box">
          <div class="row">
              <div class="col-md-3">
                <form method="post" action="<?php echo generateMemberForm("network","levelautoview",""); ?>" enctype="multipart/form-data" name="form-page" id="form-page">
