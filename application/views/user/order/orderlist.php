...
$QR_PAGES = "SELECT ord.*, CONCAT_WS(' ',tm.first_name,tm.last_name) AS full_name, tm.user_id AS user_id ,
			 tad.current_address AS order_address, tos.name AS order_state, toc.cancel_id
              ...
              <div class="col-xs-12">
                <div>
                  <table id="" class="table">
			       ...
			       ?>
                      <tr class="<?php echo ($AR_DT['cancel_id']>0)? "text text-danger":""; ?>">
                        <td><?php echo $Ctrl; ?></td>
                        ...
                        href="<?php echo generateSeoUrlMember("order","orderview",array("order_id"=>_e($AR_DT['order_id']))); ?>">View</a> 
						</td>
                      </tr>
