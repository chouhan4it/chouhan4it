...
$QR_PAGES="SELECT cms.* FROM  tbl_cms AS cms   WHERE 1 $StrWhr ORDER BY cms.id_cms ASC";
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <th width="157" align="center">Title</th>
                  ...
                  <form method="post" autocomplete="off" action="<?php echo ADMIN_PATH."operation/cms"; ?>">
			       ...
			       ?>
                      <tr>
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['id_cms']; ?> <span class="lbl"></span> </label>
                        </td>
