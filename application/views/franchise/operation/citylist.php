...
if($_REQUEST['country_code']!=''){
	...
	$StrWhr .=" AND tc.country_code LIKE '$country_code'";
	$SrchQ .="&country_code=$country_code&page=$Page";
}

$QR_PAGES="SELECT tc.* FROM  tbl_city AS tc 
			LEFT JOIN  tbl_country AS tcy ON tc.country_code=tcy.country_code  WHERE tc.isDelete>0 $StrWhr ORDER BY tc.country_code ASC";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> City<small> <i class="ace-icon fa fa-angle-double-right"></i>List </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
...
<div id="search-modal" class="modal fade" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo ADMIN_PATH."operation/citylist"; ?>" method="post"> 
      <div class="modal-body"> 
	  		
			  <div class="form-group">
				  <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Country  </label>
				  <div class="col-sm-6">
					<select class="form-control validate[required]" id="form-field-select-1" name="country_code" >
