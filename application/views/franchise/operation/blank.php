...
$AR_STOCK = $model->getTotalStockBalance($fran_id,"","");

$no_of_order = $model->getNoOfFranchiseOrder($fran_id);
$total_order = $model->getSumOfFranchiseOrder($fran_id,"","");
$today_order = $model->getSumOfFranchiseOrder($fran_id,$today_date,$today_date);
$current_month_order = $model->getSumOfFranchiseOrder($fran_id,$C_MONTH['flddFDate'],$C_MONTH['flddTDate']);
$last_month_order = $model->getSumOfFranchiseOrder($fran_id,$X_MONTH['flddFDate'],$X_MONTH['flddTDate']);
$last_month_till_date_sale = $model->getSumOfFranchiseOrder($fran_id,$X_MONTH['flddFDate'],$till_date);
      ...
      <div class="row"> <?php echo get_message(); ?><br>
        ...
        <div class="col-sm-12 infobox-container">
          ...
          <div class="infobox infobox-orange2">
            ...
            <div class="infobox-data"> <span class="infobox-data-number"><?php echo number_format($today_order); ?></span>
		  ...
		  <div class="infobox infobox-red2">
            ...
            <div class="infobox-data"> <span class="infobox-data-number"><?php echo number_format($current_month_order); ?></span>
              <div class="infobox-content">Current Month Sale </div>
            </div>
          </div>
		  <div class="infobox infobox-green2">
            ...
            <div class="infobox-data"> <span class="infobox-data-number"><?php echo number_format($last_month_order); ?></span>
              <div class="infobox-content">Last Month Sale </div>
            </div>
          </div>
          <div class="infobox infobox-orange2">
            <div class="infobox-chart"> <span class="sparkline" data-values="196,128,202,177,154,94,100,170,224">
            ...
            <div class="infobox-data"> <span class="infobox-data-number"><?php echo number_format($last_month_till_date_sale); ?></span>
              <div class="infobox-content">Last Month Till Date</div>
            </div>
          </div>
        ...
        <div class="col-xs-12 col-sm-12">
          <div class="widget-box">
            <div class="widget-header">
              <h4 class="widget-title sm"> Franchise Login History </h4>
              ...
              <div class="panel-body list">
                <div class="table-responsive project-list">
                  <table class="table table-striped">
                    <thead>
                      <?php
						$QR_LOGS = "SELECT tol.* FROM tbl_franchise_logs AS tol WHERE tol.user_name='".$ROW['user_name']."' ORDER BY tol.login_id DESC LIMIT 10";
