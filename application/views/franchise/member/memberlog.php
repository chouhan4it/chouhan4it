...
if($_REQUEST['user_name']!=''){
	...
	$StrWhr .=" AND tol.user_name LIKE '%$user_name%'";
	$SrchQ .="&user_name=$user_name";
}

$QR_PAGES="SELECT tml.* FROM tbl_mem_logs AS tml    WHERE 1 $StrWhr ORDER BY tml.login_id ASC";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> User <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Logs </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <th width="158">Login time </th>
                      <th width="134">OS</th>
                      <th width="134">Browser</th>
                      <th width="134">Login IN </th>
                      <th width="134">Log OUT </th>
                  ...
                  <tbody>
			       ...
			       ?>
                    <tr>
                      <td class="center"><label class="pos-rel"> <?php echo $AR_DT['login_id']; ?> <span class="lbl"></span> </label>                      </td>
                      <td><a href="javascript:void(0)"><?php echo $AR_DT['user_name']; ?></a> </td>
                      <td><?php echo $AR_DT['current_time']; ?></td>
                      <td><?php echo $AR_DT['operate_system']; ?></td>
                      <td><?php echo $AR_DT['browser']."-".$AR_DT['browser_version']; ?></td>
                      <td><?php echo $AR_DT['login_time']; ?></td>
                      <td><?php echo $AR_DT['logout_time']; ?></td>
...
<div id="search-modal" class="modal fade" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo ADMIN_PATH."member/memberlog"; ?>" method="post">
