...
$QR_PAGES="SELECT ts.*, tm.first_name, tm.last_name FROM  tbl_support AS ts 
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> User <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Support </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <td><a href="<?php echo generateSeoUrlAdmin("member","conversation",array("enquiry_id"=>_e($AR_DT['enquiry_id']))); ?>"> <img src="<?php echo BASE_PATH; ?>assets/img/policyicon.gif" id="<?php echo $AR_DT['enquiry_id']; ?>" class="viewChat pointer"> </a> &nbsp;&nbsp;
                       </td>
                    </tr>
                    <?php endforeach;
								}
