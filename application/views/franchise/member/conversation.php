				...
				?>
                  <div class="itemdiv dialogdiv">
                    ...
                    <div class="body">
                      ...
                      <div class="name"> <a href="#"><?php echo ($AR_DT['first_name'])? $AR_DT['first_name']:"Admin"; ?></a> <?php if($AR_DT['member_id']==0){ ?> <span class="label label-info arrowed arrowed-in-right">admin</span> <?php } ?></div>
