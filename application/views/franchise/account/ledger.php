  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Account<small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Ledger </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
        <div class="col-xs-12">
          <div class="row">
            <div class="col-xs-12">
              <div class="clearfix">
                <div class="row">
                  <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateFranchiseForm("account","ledger",""); ?>" method="post">
              ...
              <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr class="<?php echo ($AR_DT['stock_sts']=="R")? "text-danger":""; ?>">
                    ...
                    <td align="left"><?php echo number_format($cr_amount,0); ?></td>
                    <td align="left"><?php echo number_format($dr_amount,0); ?></td>
                    <td align="left"><?php echo number_format($net_balalnce,0); ?></td>
                  </tr>
                  <?php $Ctrl++; endforeach;  ?>
                </tbody>
              </table>
