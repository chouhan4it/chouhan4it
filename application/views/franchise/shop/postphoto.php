                ...
                <div class="row">
                  ...
                  <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateFranchiseForm("shop","productlist",""); ?>" method="post">
					...
					<div class="col-md-6">
						...
						<a  class="btn btn-sm btn-success open_modal"> <i class="ace-icon fa fa-plus"></i> New </a>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <th width="197">Picture</th>
                      <th width="197">Type</th>
                      <th width="197">Size </th>
                      <th width="197">Cover</th>
                  ...
                  <tbody>
			       ...
			       ?>
                    <tr>
                      ...
                      <td><a target="_blank" href="<?php echo $model->getFileSrc($AR_DT['field_id']); ?>">
					  <img src="<?php echo $model->getFileSrc($AR_DT['field_id']); ?>" width="60px" height="60px" class="img-responsive"></a></td>
                      ...
                      <td><div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-default">
							...
							<li> <a onClick="return confirm('Make sure , you want to delete this document?')" href="<?php echo generateSeoUrlFranchise("shop","postphoto",array("field_id"=>_e($AR_DT['field_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                          </ul>
                        </div></td>
                    </tr>
...
<div id="search-modal" class="modal fade" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateFranchiseForm("shop","postphoto","");  ?>" enctype="multipart/form-data" method="post">
