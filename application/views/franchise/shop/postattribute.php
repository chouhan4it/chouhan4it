...
<body class="no-skin" style="min-height:1200px;">
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <!-- PAGE CONTENT BEGINS -->
          <form class="form-horizontal"  name="form-valid" id="form-valid" action="<?php echo generateFranchiseForm("shop","postattribute",""); ?>" method="post" enctype="multipart/form-data">
		  <div class="form-group">
		   ...
		   <div class="space-2"></div>
            ...
            <div class="form-group">
              ...
              <a href="javascript:void(0)" class="btn btn-sm btn-primary" id="add_attr"><i class="fa fa-plus"></i> Add</a> &nbsp;&nbsp;<a href="javascript:void(0)" class="btn btn-sm btn-danger" id="del_attr"><i class="fa fa-times"></i> Delete</a>
              <div class="space-2"></div>
                <div class="clearfix">
              ...
              <div class="col-xs-12 col-sm-9">
                ...
                <div class="row" style="overflow-y:scroll; height:200px;" >
                	...
                	<div class="col-md-3" align="center">
                    	<img src="<?php echo $model->getFileSrc($AR_IMAGE['field_id']); ?>"  class="img-responsive">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-12 col-sm-9">
                <div class="clearfix">
                  <input name="post_attribute_discount" id="post_attribute_discount"  class="col-xs-12 col-sm-4 cal_product_price" type="text" placeholder="Discount" value="<?php echo $ROW['post_attribute_discount']; ?>">
                </div>
              </div>
            </div>
            <div class="space-2"></div>			
			<div class="form-group">
              <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="post_cmsn_price">Additional  Price : </label>
              <div class="col-xs-12 col-sm-9">
                <div class="clearfix">
             ...
             <div class="space-2"></div>			
			<div class="form-group">
              <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="post_fran_price">Selling MRP  Price : </label>
              <div class="col-xs-12 col-sm-9">
                <div class="clearfix">
                  <input name="post_attribute_mrp" id="post_attribute_mrp"  class="col-xs-12 col-sm-4 cal_product_price validate[required]" type="text" placeholder="Selling MRP Price" value="<?php echo $ROW['post_attribute_mrp']; ?>" readonly>
                </div>
              </div>
            </div>
			<div class="space-2"></div>			
			<div class="form-group">
              <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="post_fran_price">Selling  Price : </label>
              <div class="col-xs-12 col-sm-9">
                <div class="clearfix">
			...
			<div class="form-group">
              ...
              <div class="col-xs-12 col-sm-9">
                <div class="clearfix">
                  <input name="post_attribute_price" id="post_attribute_price"  class="col-xs-12 col-sm-4 cal_product_price validate[required]" type="text" placeholder="Product Price" value="<?php echo $ROW['post_attribute_price']; ?>" readonly>
                </div>
              </div>
            </div>
...
<script type="text/javascript">
	$(function(){
		...
		$("#post_selling_mrp").on('blur',function(){
			var post_selling_mrp = $("#post_selling_mrp").val();
			if(post_selling_mrp>0){
				$("#submit-post-attribute").attr('disabled',false);
			}else{
				$("#submit-post-attribute").attr('disabled',true);
			}
		});
		$(".cal_product_price").on('blur change',function(){
			...
			if(post_attribute_mrp>0){
				...
				var post_attribute_price = parseFloat(post_attribute_mrp)-parseFloat(post_attribute_discount);
		...
		function populate_attr(){
			...
			var URL_ATTR = "<?php echo FRANCHISE_PATH; ?>json/jsonhandler?switch_type=ATTR_VALUE&attribute_group_id="+attribute_group_id;
		...
		$("#add_attr").on('click',function(){
			...
			var URL_COMB = "<?php echo FRANCHISE_PATH; ?>json/jsonhandler?switch_type=ADD_ATTR_SELECT&attribute_group_id="+attribute_group_id+"&attribute_id="+attribute_id+"&select_arr="+select_arr;
		...
		$(".cal_product_price").on('blur change',function(){
			...
			var post_discount = parseFloat($("#post_attribute_discount").val());
			if(post_selling_mrp>0){
			...
			if(post_selling_mrp>0){
				...
				$.getJSON(URL_LOAD,data_param,function(json_eval){
					if(json_eval.error_sts>0){
						...
						$("#post_attribute_mrp").val(net_post_mrp);
						$("#post_cmsn").val(post_cmsn);
						$("#post_attribute_price").val(net_post_price);
						return true;
					}else{
						$("#post_attribute_mrp").val(0);
						$("#post_cmsn").val(0);
