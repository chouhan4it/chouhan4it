...
$QR_ORDER = "SELECT ord.*, CONCAT_WS(' ',tm.first_name,tm.last_name) AS full_name, tm.user_id AS user_id , tm.current_address, tm.sponsor_id, 
			 tm.city_name, tm.state_name, tm.country_name, tm.pin_code, tm.member_mobile, tad.current_address AS order_address, tad.city_name AS 
			 ship_city_name, tad.state_name AS ship_state_name, tad.country_code AS ship_country_code, tad.pin_code AS ship_pin_code, tos.name AS 
			 order_state  
            ...
            <div class="col-sm-10 col-sm-offset-1">
                      ...
                      <div>
						...
						?>
                            <tr>
                              ...
                              <td class="hidden-480"><span class="hidden-xs"><?php echo getTool($AR_ORD_DT['original_post_price'],$AR_POST['post_mrp']); ?></span></td>
                              <td class="hidden-480"><span class="hidden-xs"><?php echo number_format($AR_ORD_DT['post_selling'],2); ?></span></td>
                              <td align="right" class="hidden-480"><span class="hidden-xs"><?php echo getTool($AR_ORD_DT['post_price'],$AR_POST['post_price']); ?></span></td>
                            ...
                            <tr>
                              ...
                              <td colspan="4" align="right" class="hidden-480"><strong>Sub Total</strong></td>
                              <td align="right"><span class="hidden-480"><?php echo number_format($order_total,2); ?></span></td>
                            </tr>
                            <tr>
                              <td colspan="5" class="center">&nbsp;</td>
                              <td colspan="4" align="right" class="hidden-480"><strong>Shipping </strong></td>
                              <td align="right"><span class="hidden-480"><?php echo number_format($shipping_total,2); ?></span></td>
                            </tr>
                            <tr>
                              <td colspan="5" class="center">&nbsp;</td>
                              <td colspan="4" align="right" class="hidden-480"><strong>Total</strong></td>
                            ...
                            <tr>
                              ...
                              <td colspan="6" align="right" class="right"><table width="40%" border="1" cellpadding="4" cellspacing="4" class="table table-striped table-bordered" style="border-collapse:collapse;" >
                                  <tr>
                                    <td colspan="2">&nbsp;</td>
                                  </tr>
                                  <tr>
              ...
              <div class="row">
                <div class="col-md-6 pull-left">
                  <h5>Order Status : </h5>
                  <form method="post" name="form-history" id="form-history" action="<?php echo generateFranchiseForm("order","orderview",array("order_id"=>_e($AR_ORDER['order_id']))); ?>">
                ...
                <div class="col-md-6">
                  ...
                  <form method="post" name="form-ship" id="form-ship" action="<?php echo generateFranchiseForm("order","orderview",array("order_id"=>_e($AR_ORDER['order_id']))); ?>">
