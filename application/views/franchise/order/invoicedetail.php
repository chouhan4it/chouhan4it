...
$QR_ORDER = "SELECT ord.*, CONCAT_WS(' ',tm.first_name,tm.last_name) AS full_name, tm.user_id AS user_id, tm.current_address,
			 tm.city_name, tm.state_name, tm.country_name, tm.pin_code, tm.member_mobile, tad.current_address AS order_address, 
			 tad.city_name AS ship_city_name, tad.state_name AS ship_state_name, tad.country_code AS ship_country_code,
                            ...
                            <table width="100%" border="0">
                              ...
                              <tr>
                                <td align="left"><table width="100%" border="0">
                                    <tr>
                                      <td><strong><?php echo strtoupper($AR_FRAN['store']); ?></strong></td>
                                    </tr>
                                    <tr>
                                ...
                                <td align="right"><table width="100%" border="0">
                                    <tr>
                                      <td><table width="100%" border="0">
                                          <tr>
                                            ...
                                            <td width="53%" rowspan="6"><img src="<?php echo LOGO; ?>" width="100" height="100"> </td>
                                          </tr>
                                          <tr>
                                    ...
                                    <tr>
                                      <td><table width="100%" border="0">
                                          ...
                                          <tr>
                                            <td><?php echo number_format($AR_ORDER['total_paid_real'],2); ?></td>
                                            <td><?php echo number_format($AR_ORDER['total_paid'],2); ?></td>
                                            <td><?php echo number_format($AR_ORDER['total_paid_real']-$AR_ORDER['total_paid'],2); ?></td>
                                          </tr>
                                        </table></td>
                                    </tr>
                                    <tr>
                                ...
                                <td colspan="2" align="center"><table width="100%"  class="table">
                                    <thead>
                                      <tr>
                                        ...
                                        <th width="5%" class="center">Amt</th>
                                        <th width="4%" class="center">Qty</th>
                                        <th width="9%" class="center">Net Amount</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                      <?php 
                                      ...
                                      <tr>
                                        ...
                                        <td align="left"><?php echo $AR_ORD_DT['post_attribute']; ?></td>
									...
									$net_order_amount = $order_total + $shipping_total;
									
									$base_amount =  $order_total-$order_tax;
									$vat_age = ($order_tax/$base_amount)*100;
									?>
                                       <tr>
                                        <td colspan="8" align="left" class="left">&nbsp;</td>
                                        <td align="right" class="center"><strong>Sub Total</strong></td>
                                        <td align="right" class="hidden-480"><?php echo number_format($order_total,2); ?></td>
                                      </tr>
                                      <tr>
                                        <td colspan="8" align="left" class="left">&nbsp;</td>
                                        <td align="right" class="center"><strong>Shipping </strong></td>
                                        <td align="right" class="hidden-480"><?php echo number_format($shipping_total,2); ?></td>
                                      </tr>
                                      <tr>
                                        <td colspan="8" align="left" class="left"><strong>Amount in words :</strong> &nbsp;&nbsp; <u><?php echo convert_number($net_order_amount); ?> only </u> /-</td>
                                        <td align="right" class="center"><strong>Total</strong></td>
                                        <td align="right" class="hidden-480"><strong><?php echo number_format($net_order_amount,2); ?></strong><br>
                        ...
                        <div class="col-sm-12 pull-left"><strong>
                          <table width="100%" border="0">
                            ...
                            <tr>
                              ...
                              <td align="right">For <strong><?php echo strtoupper(WEBSITE); ?></td>
                            </tr>
                            <tr>
