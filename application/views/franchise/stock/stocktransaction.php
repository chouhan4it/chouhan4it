...
$StrWhr .=" AND (tsm.franchisee_id_to='".$franchisee_id."')";
...
$QR_PAGES= "SELECT tsm.*, SUM(tsm.post_amount) AS total_amt, tf.name AS franchisee_name_from, ttf.name AS franchisee_name_to
        ...
        <div class="col-xs-12">
          <div class="row">
            <div class="col-xs-12">
              <div class="clearfix">
                <div class="row">
                  <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateFranchiseForm("stock","stocktransaction",""); ?>" method="post">
                    <div class="col-md-4">
              ...
              <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <th width="117"> Request To </th>
                    <th width="117">Order Amount </th>
                ...
                <tbody>
                  ...
                  <tr class="<?php echo ($AR_DT['stock_sts']=="R")? "text-danger":""; ?>">
                    ...
                    <td><?php echo $AR_DT['franchisee_name_from']; ?></td>
                    ...
                    <td align="center"><div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default">
						  ...
						  <li> <a  href="<?php echo generateSeoUrlFranchise("stock","stockdetail",array("order_no"=>_e($AR_DT['order_no']))); ?>">View</a> </li>					
                        </ul>
                      </div></td>
                  </tr>
