  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1>Stock <small> <i class="ace-icon fa fa-angle-double-right"></i> Detail</small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php  get_message(); ?>
        <div class="col-xs-12">
          ...
          <table width="600" border="0" align="center" cellpadding="5" cellspacing="0"  class="table">
            <tr>
              <td width="444">&nbsp;</td>
              <td width="76" align="right"><img src="<?php echo BASE_PATH; ?>setupimages/button_back.gif" alt="Back" width="50" height="20" border="0" align="right" class="pointer" onClick="window.location.href='<?php echo generateSeoUrlFranchise("stock","stocktransaction",array("")); ?>'" /></td>
            ...
            <tr>
              <td colspan="3" align="center" class="cmntext" id="Letter"><table class="table" width="100%" border="0" cellpadding="5" cellspacing="0" style="border:1px solid #EBEBEB;">
                  ...
                  <tr>
                    <td width="40%" class="cmntext"><?php echo $AR_MSTR['franchisee_name_from']; ?></td>
                  ...
                  <tr>
                    <td align="left" valign="top" class="cmntext"> Order No:
                      ...
                      <br />
                      Order Date: 
                      <?php  echo $AR_MSTR['order_date']; ?></td>
                  ...
                  <tr>
                    <td colspan="2" align="center" valign="top"><table class="table" width="100%" border="0" cellpadding="5" cellspacing="0" style="border:1px solid #EBEBEB;">
                        <tr>
                          ...
                          <td align="left" class="cmntext"><strong>PRODUCT</strong></td>
                          <td align="left" class="cmntext"><strong>MRP</strong></td>
                          <td align="center" class="cmntext"><strong>PURCHASE</strong></td>
						...
						?>
							<tr class="<?php echo ($AR_STOCK['stock_sts']=="R")? "text-danger":""; ?>">
							  ...
							  <td align="left" class="cmntext"> <?php echo $AR_STOCK['product_price'];?></td>
							  <td align="center" class="cmntext"> <?php echo number_format($AR_STOCK['post_price']);?></td>
						      <td align="center" class="cmntext"><?php echo $AR_STOCK['post_qty'];?></td>
						      <td align="center" class="cmntext"> <strong><?php echo number_format($AR_STOCK['post_amount']);?></strong></td>
							</tr>
							<?php 
						$Ctrl++;
						} 
                        ...
                        <tr>
                          <td colspan="6" align="right" class="cmntext"><strong>(Rupees <?php echo convert_number($net_pay_amount);?> Only)</strong></td>
                        </tr>
                      </table></td>
                  </tr>
                  <tr>
