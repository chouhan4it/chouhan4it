...
config. FontSize		= '11px' 	// E.g. '9pt' or '12px' - specifying the unit is mandatory
...
config. TitleFontSize	= '15'		// If '' use FontSize
config. Width			= 500 		// Tooltip width; 0 for automatic adaption to tooltip content
